package alternativa.math
{
   public class Matrix4
   {
      ...
      public function transformPoint(vin:Vector3, vout:Vector3) : void
      {
      ...
      public function transformPointTransposed(vin:Vector3, vout:Vector3) : void
      {
      ...
      public function transformPoints(arrin:Vector.<Vector3>, arrout:Vector.<Vector3>) : void
      {
      ...
      public function transformPointsN(arrin:Vector.<Vector3>, arrout:Vector.<Vector3>, len:int) : void
      {
         var vin:Vector3 = null;
         var vout:Vector3 = null;
         for(var idx:int = 0; idx < len; idx++)
      ...
      public function transformPointsTransposed(arrin:Vector.<Vector3>, arrout:Vector.<Vector3>) : void
      {
         var vin:Vector3 = null;
         var vout:Vector3 = null;
         var xx:Number = NaN;
      ...
      public function transformPointsTransposedN(arrin:Vector.<Vector3>, arrout:Vector.<Vector3>, len:int) : void
      {
         var vin:Vector3 = null;
         var vout:Vector3 = null;
         var xx:Number = NaN;
      ...
      public function setAxes(xAxis:Vector3, yAxis:Vector3, zAxis:Vector3, pos:Vector3) : void
      {
         this.a = xAxis.x;
         this.e = xAxis.y;
         this.i = xAxis.z;
      ...
      public function transformVectorTransposed(vin:Vector3, vout:Vector3) : void
      {
      ...
      public function setRotationMatrix(rx:Number, ry:Number, rz:Number) : void
      {
