package alternativa.math
{
   ...
   public class Quaternion
   {
      ...
      public static function createFromEulerAnglesXYZ(x:Number, y:Number, z:Number) : Quaternion
      {
         var q:Quaternion = new Quaternion();
         q.setFromAxisAngleComponents(1,0,0,x);
      ...
      public function toAxisVector(v:Vector3 = null) : Vector3
      {
         ...
         if(this.w > -1 && this.w < 1)
         {
            ...
            else
            {
               ...
               v.x = this.x * _loc3_ * _loc2_;
               v.y = this.y * _loc3_ * _loc2_;
               v.z = this.z * _loc3_ * _loc2_;
            }
         }
         else
         {
      ...
      public function slerp(a:Quaternion, b:Quaternion, t:Number) : Quaternion
      {
         ...
         {
            _loc8_ = Number(Math.acos(cosine));
            _loc9_ = Number(Math.sin(_loc8_));
            _loc10_ = Math.sin((1 - t) * _loc8_) / _loc9_;
            _loc11_ = Math.sin(t * _loc8_) / _loc9_ * flip;
            this.w = a.w * _loc10_ + b.w * _loc11_;
            this.x = a.x * _loc10_ + b.x * _loc11_;
            this.y = a.y * _loc10_ + b.y * _loc11_;
            this.z = a.z * _loc10_ + b.z * _loc11_;
         }
         return this;
      }
   }
