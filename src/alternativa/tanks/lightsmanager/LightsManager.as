package alternativa.tanks.lightsmanager
{
   ...
   public class LightsManager
   {
      ...
      public function LightsManager(param1:RenderSystem)
      {
         ...
         this.name_02[LIGHT_TYPE_AMBIENT] = new AmbientLightRegistry(param1);
         this.name_02[LIGHT_TYPE_DIRECTIONAL] = new DirectionalLightRegistry(param1);
         this.name_02[LIGHT_TYPE_OMNI] = new OmniLightRegistry(param1);
         this.name_02[LIGHT_TYPE_SPOT] = new SpotLightRegistry(param1);
      }
