package alternativa.tanks.game.usertitle
{
   ...
   public class §_-K9§
   {
      ...
      public function §_-K9§(x:int, y:int, maxValue:int, barWidth:int, skin:§_-4R§)
      {
         super();
         this.x = x;
         this.y = y;
      ...
      public function §_-gM§(skin:§_-4R§) : void
      {
         this.skin = skin;
      ...
      public function draw(texture:BitmapData) : void
      {
         ...
         if(displayWidth >= this.§_-oy§)
         {
            ...
            {
               this.§_-6J§(g,this.skin.§_-9Y§,this.skin.§_-j2§,this.skin.§_-oU§);
            ...
            else
            {
               ...
               if(displayWidth > this.§_-oy§)
               {
                  ...
                  bgStart = displayWidth;
                  this.§_-SU§(g,this.skin.§_-oU§,this.§_-oy§,displayWidth - this.§_-oy§);
               }
               else
               {
                  bgStart = this.§_-oy§;
         ...
         if(bgStart == 0)
         {
            this.§_-6J§(g,this.skin.§_-XU§,this.skin.§_-GY§,this.skin.§_-py§);
         }
         else if(bgStart < this.barWidth)
         {
            this.§_-SU§(g,this.skin.§_-py§,bgStart,w - bgStart);
            matrix.tx = w;
      ...
      private function §_-6J§(g:Graphics, leftTip:BitmapData, rightTip:BitmapData, center:BitmapData) : void
      {
         var w:int = this.barWidth - this.§_-oy§;
      ...
      private function §_-SU§(g:Graphics, center:BitmapData, x:int, width:int) : void
      {
         matrix.tx = x;
         g.beginBitmapFill(center,matrix,true);
