package alternativa.tanks.game.usertitle
{
   ...
   public class name_559
   {
      ...
      public static const HEALTHBAR_DM:name_559 = new name_559(COLOR_DM,hpGreenEmpty,hpGreenFull,4);
      
      public static const HEALTHBAR_BLUE:name_559 = new name_559(COLOR_TEAM_BLUE,hpBlueEmpty,hpBlueFull,4);
      
      public static const HEALTHBAR_RED:name_559 = new name_559(COLOR_TEAM_RED,hpRedEmpty,hpRedFull,4);
      
      public static const WEAPONBAR:name_559 = new name_559(0,weaponEmpty,weaponFull,4);
      
      public var var_701:BitmapData;
      
      public var var_699:BitmapData;
      ...
      public function name_559(color:uint, emptyBitmap:BitmapData, fullBitmap:BitmapData, tipWidth:int)
      {
         super();
         this.color = color;
         var parts:name_592 = new name_592(emptyBitmap,tipWidth);
         this.var_701 = parts.left;
         this.var_700 = parts.right;
         this.var_704 = parts.center;
         parts = new name_592(fullBitmap,tipWidth);
         this.var_699 = parts.left;
         this.var_702 = parts.right;
         this.var_703 = parts.center;
      }
   }
}
