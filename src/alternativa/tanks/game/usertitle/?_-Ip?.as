package alternativa.tanks.game.usertitle
{
   ...
   public class §_-Ip§
   {
      ...
      private var userTitle:§class§;
      
      private var state:int;
      
      private var §_-VQ§:Boolean;
      
      public function §_-Ip§(effectId:int, blinkingTime:int, userTitle:§class§, initialBlinkInterval:int, blinkIntervalDecrement:int)
      {
         super();
         this.§_-oz§ = effectId;
         ...
         this.§_-Jj§ = new §_-Lf§(initialBlinkInterval,20,blinkIntervalDecrement,MIN_ALPHA,1,10);
      ...
      public function §_-Vi§(x:int, y:int) : void
      {
         this.x = x;
         this.y = y;
         this.§_-aw§ = true;
      ...
      private function §_-2Z§(now:int, delta:int, texture:BitmapData) : void
      {
         var newAlpha:Number = NaN;
         if(this.§_-VQ§)
         {
            newAlpha = Number(this.§_-Jj§.§_-5N§(now,delta));
