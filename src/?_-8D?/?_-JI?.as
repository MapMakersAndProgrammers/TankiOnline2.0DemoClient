package §_-8D§
{
   ...
   public class §_-JI§ extends Sprite
   {
      private static var drawDistanceFragment:§_-hR§;
      
      private static var drawDistanceVertexProcedure:§_-Xk§;
      ...
      private static const drawUnit:§_-QF§ = new §_-QF§();
      ...
      private static const branch:Vector.<§_-OX§> = new Vector.<§_-OX§>();
      
      private static const overedBranch:Vector.<§_-OX§> = new Vector.<§_-OX§>();
      
      private static const changedBranch:Vector.<§_-OX§> = new Vector.<§_-OX§>();
      ...
      private var surfaces:Vector.<§_-a2§>;
      
      private var geometries:Vector.<§_-gA§>;
      
      private var §_-2L§:Vector.<§_-Xk§>;
      ...
      private var §extends§:Vector.<Vector.<§_-a2§>>;
      ...
      private var target:§_-OX§;
      
      private var targetSurface:§_-a2§;
      
      private var §_-Cu§:Number;
      
      private var §_-B4§:§_-OX§;
      
      private var §_-c3§:§_-OX§;
      
      private var §_-Lx§:§_-OX§;
      
      private var §_-H7§:§_-a2§;
      ...
      public function §_-JI§(width:int, height:int, renderToBitmap:Boolean = false, backgroundColor:uint = 0, backgroundAlpha:Number = 1, antiAlias:int = 0)
      {
         var item:ContextMenuItem;
         var menu:ContextMenu;
         this.§_-j6§ = new Vector.<MouseEvent>();
         this.indices = new Vector.<int>();
         this.surfaces = new Vector.<§_-a2§>();
         this.geometries = new Vector.<§_-gA§>();
         this.§_-2L§ = new Vector.<§_-Xk§>();
         this.alternativa3d::_-Cr = new Vector.<Vector3D>();
         this.alternativa3d::_-g4 = new Vector.<Vector3D>();
         this.§_-Ql§ = new Vector.<Point>();
         this.§extends§ = new Vector.<Vector.<§_-a2§>>();
         ...
         tabEnabled = false;
         tabChildren = false;
         item = new ContextMenuItem("Powered by Alternativa3D " + §_-fn§.version);
         ...
         {
            drawDistanceVertexProcedure = §_-Xk§.§_-En§(["#v0=distance","#c0=transform0","#c1=transform1","#c2=transform2","#c3=coefficient","#c4=projection","dp4 t0.x, i0, c0","dp4 t0.y, i0, c1","dp4 t0.z, i0, c2","mul v0.x, t0.z, c3.z","mov v0.y, i0.x","mov v0.z, i0.x","mov v0.w, i0.x","mul t1.x, t0.x, c4.x","mul t1.y, t0.y, c4.y","mul t0.w, t0.z, c4.z","add t1.z, t0.w, c4.w","mov t3.z, c4.x","div t3.z, t3.z, c4.x","sub t3.z, t3.z, c3.w","mul t1.w, t0.z, t3.z","add t1.w, t1.w, c3.w","mul t0.x, c3.x, t1.w","mul t0.y, c3.y, t1.w","add t1.x, t1.x, t0.x","add t1.y, t1.y, t0.y","mov o0, t1"],"mouseEventsVertex");
            drawDistanceFragment = new §_-hR§(Context3DProgramType.FRAGMENT);
            drawDistanceFragment.§_-on§(new §_-Xk§(["mov t0.z, c0.z","mov t0.w, c0.w","frc t0.y, v0.x","sub t0.x, v0.x, t0.y","mul t0.x, t0.x, c0.x","mov o0, ft0","#v0=distance","#c0=code"],"mouseEventsFragment"));
         }
         addEventListener(MouseEvent.MOUSE_DOWN,this.§_-2B§);
         addEventListener(MouseEvent.CLICK,this.§_-2B§);
         addEventListener(MouseEvent.DOUBLE_CLICK,this.§_-2B§);
         addEventListener(MouseEvent.MOUSE_MOVE,this.§_-2B§);
         addEventListener(MouseEvent.MOUSE_OVER,this.§_-2B§);
         addEventListener(MouseEvent.MOUSE_WHEEL,this.§_-2B§);
         addEventListener(MouseEvent.MOUSE_OUT,this.§_-CS§);
      ...
      private function §_-Id§(e:Event) : void
      {
         ...
         stage.addEventListener(KeyboardEvent.KEY_UP,this.§_-Uf§);
      }
      
      private function §_-99§(e:Event) : void
      {
         stage.removeEventListener(KeyboardEvent.KEY_DOWN,this.§_-Ze§);
         stage.removeEventListener(KeyboardEvent.KEY_UP,this.§_-Uf§);
         this.altKey = false;
         this.ctrlKey = false;
         this.shiftKey = false;
      }
      
      private function §_-Ze§(keyboardEvent:KeyboardEvent) : void
      {
         ...
         if(this.ctrlKey && this.shiftKey && keyboardEvent.keyCode == Keyboard.F1 && this.§_-OE§ == null)
         {
            ...
            setTimeout(this.§_-4j§,2048);
         }
      }
      
      private function §_-Uf§(keyboardEvent:KeyboardEvent) : void
      {
         this.altKey = keyboardEvent.altKey;
         this.ctrlKey = keyboardEvent.ctrlKey;
         this.shiftKey = keyboardEvent.shiftKey;
      ...
      alternativa3d function calculateRays(camera:§_-be§) : void
      {
         var i:int = 0;
            ...
            if(mouseEvent.type != "mouseOut")
            {
               if(mouseEvent.localX != mouseX || mouseEvent.localY != mouseY)
               {
                  ...
                  else
                  {
                     ...
                     this.§extends§[this.alternativa3d::raysLength] = new Vector.<§_-a2§>();
      ...
      alternativa3d function §_-bA§(surface:§_-a2§, geometry:§_-gA§, procedure:§_-Xk§) : void
      {
      ...
      alternativa3d function §_-jR§(stage3D:Stage3D, context:Context3D) : void
      {
      ...
      alternativa3d function §_-7K§(context:Context3D, camera:§_-be§) : void
      {
         var i:int = 0;
         var raySurfaces:Vector.<§_-a2§> = null;
         ...
         if(this.§_-Zv§ > 0)
         {
            if(this.§_-8b§ > 0)
            {
               this.§_-oI§(context,camera,this.alternativa3d::_-qj,this.alternativa3d::_height);
            ...
            for(i = 0; i < this.§_-Zv§; i++)
            {
               ...
               switch(mouseEvent.type)
               {
                  case "mouseDown":
                     ...
                     if(this.target != null)
                     {
                        this.§_-AJ§(MouseEvent3D.MOUSE_DOWN,mouseEvent,camera,this.target,this.targetSurface,this.§_-lx§(this.target,branch));
                     }
                  ...
                  case "mouseWheel":
                     ...
                     if(this.target != null)
                     {
                        this.§_-AJ§(MouseEvent3D.MOUSE_WHEEL,mouseEvent,camera,this.target,this.targetSurface,this.§_-lx§(this.target,branch));
                     }
                     break;
                  case "click":
                     this.§_-7f§(index);
                     if(this.target != null)
                     {
                        this.§_-AJ§(MouseEvent3D.MOUSE_UP,mouseEvent,camera,this.target,this.targetSurface,this.§_-lx§(this.target,branch));
                        if(this.§_-B4§ == this.target)
                        {
                           this.§_-c3§ = this.target;
                           this.§_-AJ§(MouseEvent3D.CLICK,mouseEvent,camera,this.target,this.targetSurface,this.§_-lx§(this.target,branch));
                        }
                     }
                     this.§_-B4§ = null;
                     break;
                  case "doubleClick":
                     ...
                     if(this.target != null)
                     {
                        ...
                        if(this.§_-B4§ == this.target)
                        {
                           this.§_-AJ§(this.§_-c3§ == this.target && Boolean(this.target.doubleClickEnabled) ? MouseEvent3D.DOUBLE_CLICK : MouseEvent3D.CLICK,mouseEvent,camera,this.target,this.targetSurface,this.§_-lx§(this.target,branch));
                        }
                     }
                     this.§_-c3§ = null;
                     this.§_-B4§ = null;
                  ...
                  case "mouseMove":
                     ...
                     if(this.target != null)
                     {
                        this.§_-AJ§(MouseEvent3D.MOUSE_MOVE,mouseEvent,camera,this.target,this.targetSurface,this.§_-lx§(this.target,branch));
                     }
                     if(this.§_-Lx§ != this.target)
                     {
                        this.§_-px§(mouseEvent,camera);
                     }
                     break;
                  case "mouseOut":
                     this.§_-Ki§ = null;
      ...
      private function §_-oI§(context:Context3D, camera:§_-be§, contextWidth:int, contextHeight:int) : void
      {
         var vLinker:§_-hR§ = null;
         var fLinker:§_-hR§ = null;
         var i:int = 0;
         var j:int = 0;
         var log2Width:int = 0;
         ...
         var drawRectGeometry:§_-gA§ = drawRectGeometries[context];
         if(drawRectGeometry == null)
         {
            drawRectGeometry = new §_-gA§(4);
            drawRectGeometry.addVertexStream([§_-d6§.POSITION,§_-d6§.POSITION,§_-d6§.POSITION,§_-d6§.TEXCOORDS[0],§_-d6§.TEXCOORDS[0]]);
            drawRectGeometry.setAttributeValues(§_-d6§.POSITION,Vector.<Number>([0,0,1,0,1,1,1,1,1,1,0,1]));
            drawRectGeometry.setAttributeValues(§_-d6§.TEXCOORDS[0],Vector.<Number>([0,0,0,1,1,1,1,0]));
         ...
         var drawColoredRectProgram:§_-RB§ = drawColoredRectPrograms[context];
         if(drawColoredRectProgram == null)
         {
            vLinker = new §_-hR§(Context3DProgramType.VERTEX);
            vLinker.§_-on§(§_-Xk§.§_-En§(["#a0=a0","#c0=c0","mul t0.x, a0.x, c0.x","mul t0.y, a0.y, c0.y","add o0.x, t0.x, c0.z","add o0.y, t0.y, c0.w","mov o0.z, a0.z","mov o0.w, a0.z"]));
            fLinker = new §_-hR§(Context3DProgramType.FRAGMENT);
            fLinker.§_-on§(§_-Xk§.§_-En§(["#c0=c0","mov o0, c0"]));
            drawColoredRectProgram = new §_-RB§(vLinker,fLinker);
            drawColoredRectProgram.upload(context);
            drawColoredRectPrograms[context] = drawColoredRectProgram;
         }
         var drawTexturedRectProgram:§_-RB§ = drawTexturedRectPrograms[context];
         if(drawTexturedRectProgram == null)
         {
            vLinker = new §_-hR§(Context3DProgramType.VERTEX);
            vLinker.§_-on§(§_-Xk§.§_-En§(["#a0=a0","#a1=a1","#v0=v0","#c0=c0","#c1=c1","mul v0, a1, c1","mul t0.x, a0.x, c0.x","mul t0.y, a0.y, c0.y","add o0.x, t0.x, c0.z","add o0.y, t0.y, c0.w","mov o0.z, a0.z","mov o0.w, a0.z"]));
            fLinker = new §_-hR§(Context3DProgramType.FRAGMENT);
            fLinker.§_-on§(§_-Xk§.§_-En§(["#v0=v0","#s0=s0","tex t0, v0, s0 <2d, nearest, mipnone>","mov o0, t0"]));
            drawTexturedRectProgram = new §_-RB§(vLinker,fLinker);
            ...
            for(j = 0; j < this.§_-8b§; )
            {
               if(pixelIndex == 0)
               {
                  ...
                  else
                  {
                     ...
                     context.setVertexBufferAt(0,drawRectGeometry.alternativa3d::getVertexBuffer(§_-d6§.POSITION),drawRectGeometry.alternativa3d::_attributesOffsets[§_-d6§.POSITION],§_-d6§.alternativa3d::FORMATS[§_-d6§.POSITION]);
               ...
               this.§_-6R§(context,camera,j,m0,m5,m10,m11,(pixelIndex * 2 / contextWidth - rayCoefficients.x) * drawTextureWidthScale + drawTextureWidthOffset,rayCoefficients.y * drawTextureHeightScale - drawTextureHeightOffset,kZ,fragmentConst,camera.orthographic);
               ...
               if(pixelIndex >= contextWidth || i >= this.alternativa3d::raysLength && j >= this.§_-8b§)
               {
                  if(this.antiAlias > 0)
                  {
                     ...
                     context.setVertexBufferAt(0,drawRectGeometry.alternativa3d::getVertexBuffer(§_-d6§.POSITION),drawRectGeometry.alternativa3d::_attributesOffsets[§_-d6§.POSITION],§_-d6§.alternativa3d::FORMATS[§_-d6§.POSITION]);
                     context.setVertexBufferAt(1,drawRectGeometry.alternativa3d::getVertexBuffer(§_-d6§.TEXCOORDS[0]),drawRectGeometry.alternativa3d::_attributesOffsets[§_-d6§.TEXCOORDS[0]],§_-d6§.alternativa3d::FORMATS[§_-d6§.TEXCOORDS[0]]);
                     context.setProgramConstantsFromVector(Context3DProgramType.VERTEX,0,drawColoredRectConst);
      ...
      private function §_-6R§(context:Context3D, camera:§_-be§, index:int, m0:Number, m5:Number, m10:Number, m14:Number, xOffset:Number, yOffset:Number, vertexConst:Number, fragmentConst:Number, orthographic:Boolean) : void
      {
         var i:int = 0;
         var vertex:§_-hR§ = null;
         var position:String = null;
         var surface:§_-a2§ = this.surfaces[index];
         var geometry:§_-gA§ = this.geometries[index];
         var procedure:§_-Xk§ = this.§_-2L§[index];
         var object:§_-OX§ = surface.alternativa3d::object;
         var drawDistanceProgram:§_-RB§ = drawDistancePrograms[procedure];
         if(drawDistanceProgram == null)
         {
            vertex = new §_-hR§(Context3DProgramType.VERTEX);
            position = "position";
            vertex.§_-LU§(position,§_-5§.ATTRIBUTE);
            if(procedure != null)
            {
               vertex.§_-on§(procedure);
               vertex.§_-LU§("localPosition",§_-5§.TEMPORARY);
               vertex.§_-FS§(procedure,position);
               vertex.§_-qd§(procedure,"localPosition");
               position = "localPosition";
            }
            vertex.§_-on§(drawDistanceVertexProcedure);
            vertex.§_-FS§(drawDistanceVertexProcedure,position);
            drawDistanceProgram = new §_-RB§(vertex,drawDistanceFragment);
            drawDistanceFragment.§_-NA§(vertex);
            drawDistanceProgram.upload(context);
            drawDistancePrograms[procedure] = drawDistanceProgram;
         }
         var buffer:VertexBuffer3D = geometry.alternativa3d::getVertexBuffer(§_-d6§.POSITION);
         if(buffer == null)
         {
            return;
         }
         ...
         drawUnit.alternativa3d::_-Xd(drawDistanceProgram.vertexShader.getVariableIndex("transform0"),object.alternativa3d::localToCameraTransform);
         drawUnit.alternativa3d:: if(drawDistanceProgram.vertexShader.getVariableIndex("coefficient"),xOffset,yOffset,vertexConst,orthographic ? 1 : 0);
         drawUnit.alternativa3d:: if(drawDistanceProgram.vertexShader.getVariableIndex("projection"),m0,m5,m10,m14);
         drawUnit.alternativa3d::_-Ry(drawDistanceProgram.fragmentShader.getVariableIndex("code"),fragmentConst,0,0,1);
         context.setProgram(drawDistanceProgram.program);
         context.setVertexBufferAt(0,buffer,geometry.alternativa3d::_attributesOffsets[§_-d6§.POSITION],§_-d6§.alternativa3d::FORMATS[§_-d6§.POSITION]);
      ...
      private function sort(surfaces:Vector.<§_-a2§>, depths:Vector.<Number>, length:int) : void
      {
         var r:int = 0;
         var j:int = 0;
         var l:int = 0;
      ...
      private function §_-px§(mouseEvent:MouseEvent, camera:§_-be§) : void
      {
         var changedBranchLength:int = 0;
         var i:int = 0;
         var j:int = 0;
         var object:§_-OX§ = null;
         this.§_-lx§(this.target,branch);
         this.§_-lx§(this.§_-Lx§,overedBranch);
         var branchLength:int = int(branch.length);
         var overedBranchLength:int = int(overedBranch.length);
         if(this.§_-Lx§ != null)
         {
            this.§_-AJ§(MouseEvent3D.MOUSE_OUT,mouseEvent,camera,this.§_-Lx§,this.§_-H7§,overedBranch,true,this.target);
            ...
            if(changedBranchLength > 0)
            {
               ...
               this.§_-AJ§(MouseEvent3D.ROLL_OUT,mouseEvent,camera,this.§_-Lx§,this.§_-H7§,changedBranch,false,this.target);
            }
         }
         if(this.target != null)
         {
            ...
            {
               changedBranch.length = changedBranchLength;
               this.§_-AJ§(MouseEvent3D.ROLL_OVER,mouseEvent,camera,this.target,this.targetSurface,changedBranch,false,this.§_-Lx§);
            }
            this.§_-AJ§(MouseEvent3D.MOUSE_OVER,mouseEvent,camera,this.target,this.targetSurface,branch,true,this.§_-Lx§);
      ...
      private function §_-lx§(object:§_-OX§, vector:Vector.<§_-OX§>) : Vector.<§_-OX§>
      {
      ...
      private function §_-AJ§(type:String, mouseEvent:MouseEvent, camera:§_-be§, target:§_-OX§, targetSurface:§_-a2§, objects:Vector.<§_-OX§>, bubbles:Boolean = true, relatedObject:§_-OX§ = null) : void
      {
         var object:§_-OX§ = null;
         ...
         for(i = oblectsLength - 1; i > 0; )
         {
            ...
            if(object.alternativa3d::captureListeners != null)
            {
               ...
               if(vector != null)
               {
                  ...
                  {
                     this.§_-K3§(camera,target.alternativa3d::cameraToLocalTransform,this.§_-Cu§,mouseEvent);
      ...
      private function §_-K3§(camera:§_-be§, transform:§_-jw§, z:Number, mouseEvent:MouseEvent) : void
      {
         var x:Number = NaN;
         var y:Number = NaN;
         if(!camera.orthographic)
      ...
      private function §_-7f§(index:int) : void
      {
         var source:§_-OX§ = null;
         var surface:§_-a2§ = null;
         var depth:Number = NaN;
         var object:§_-OX§ = null;
         var potentialTarget:§_-OX§ = null;
         var obj:§_-OX§ = null;
         var surfaces:Vector.<§_-a2§> = this.§extends§[index];
      ...
      public function get §_-oJ§() : String
      {
         return this.§_-bx§;
      }
      
      public function set §_-oJ§(value:String) : void
      {
         this.§_-bx§ = value;
         this.§package§();
      }
      ...
      public function set §_-dV§(value:Number) : void
      {
         this.§_-hq§ = value;
         this.§package§();
      }
      
      public function get §_-C2§() : Number
      {
         return this.§_-Xc§;
      }
      
      public function set §_-C2§(value:Number) : void
      {
         this.§_-Xc§ = value;
         this.§package§();
      }
