package package_15
{
   ...
   import package_78.name_307;
   import package_78.name_308;
   
   public class name_102
   {
      private var var_85:name_308 = new name_308();
      ...
      {
         if(Boolean(this.var_85.contains(task)) && !this.var_86.contains(task))
         {
      ...
      public function name_106() : void
      {
         ...
         this.method_103();
         var iterator:name_307 = this.var_85.listIterator();
      ...
      public function name_110() : void
      {
         var task:class_1 = null;
         var listIterator:name_307 = this.var_85.listIterator();
      ...
      private function method_103() : void
      {
         var task:class_1 = null;
         var taskInterfaces:Vector.<Class> = null;
         var taskInterface:Class = null;
         var activeTasksIterator:name_307 = null;
         ...
         for(var i:int = 0; i < this.var_87.numTasks; i++)
         {
            ...
            task.var_4 = this;
            task.start();
            taskInterfaces = this.method_101(task);
      ...
      private function method_102() : void
      {
         var task:class_1 = null;
         var taskInterfaces:Vector.<Class> = null;
         var taskInterface:Class = null;
      ...
      private function method_101(object:Object) : Vector.<Class>
      {
