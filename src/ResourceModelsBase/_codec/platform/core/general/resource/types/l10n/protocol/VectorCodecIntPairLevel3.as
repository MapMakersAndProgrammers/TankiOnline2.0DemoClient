package _codec.platform.core.general.resource.types.l10n.protocol
{
   ...
   public class VectorCodecIntPairLevel3 implements ICodec
   {
      ...
      public function VectorCodecIntPairLevel3(param1:Boolean)
      {
         super();
      ...
      {
         this.elementCodec = param1.getCodec(new TypeCodecInfo(IntPair,false));
      ...
      {
         var _loc5_:int = 0;
         var _loc6_:Vector.<Vector.<IntPair>> = null;
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:Vector.<IntPair> = null;
         var _loc10_:int = 0;
         var _loc2_:int = int(LengthCodecHelper.decodeLength(param1));
         var _loc3_:Vector.<Vector.<Vector.<IntPair>>> = new Vector.<Vector.<Vector.<IntPair>>>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            if(!param1.optionalMap.get())
            {
               ...
               _loc6_ = new Vector.<Vector.<IntPair>>(_loc5_,true);
               ...
               while(_loc7_ < _loc5_)
               {
                  if(!param1.optionalMap.get())
                  {
                     ...
                     _loc9_ = new Vector.<IntPair>(_loc8_,true);
                     _loc6_[_loc7_] = _loc9_;
                     _loc10_ = 0;
                     while(_loc10_ < _loc8_)
                     {
                        _loc9_[_loc10_] = IntPair(this.elementCodec.decode(param1));
                        _loc10_++;
                     }
                  }
                  _loc7_++;
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:Vector.<Vector.<Vector.<IntPair>>> = Vector.<Vector.<Vector.<IntPair>>>(param2);
