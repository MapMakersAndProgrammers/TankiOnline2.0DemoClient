package _codec.platform.core.general.resource.types.l10n.protocol
{
   ...
   public class VectorCodecBooleanPairLevel3 implements ICodec
   {
      ...
      public function VectorCodecBooleanPairLevel3(param1:Boolean)
      {
         super();
      ...
      {
         this.elementCodec = param1.getCodec(new TypeCodecInfo(BooleanPair,false));
      ...
      {
         var _loc5_:int = 0;
         var _loc6_:Vector.<Vector.<BooleanPair>> = null;
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:Vector.<BooleanPair> = null;
         var _loc10_:int = 0;
         var _loc2_:int = int(LengthCodecHelper.decodeLength(param1));
         var _loc3_:Vector.<Vector.<Vector.<BooleanPair>>> = new Vector.<Vector.<Vector.<BooleanPair>>>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            if(!param1.optionalMap.get())
            {
               ...
               _loc6_ = new Vector.<Vector.<BooleanPair>>(_loc5_,true);
               ...
               while(_loc7_ < _loc5_)
               {
                  if(!param1.optionalMap.get())
                  {
                     ...
                     _loc9_ = new Vector.<BooleanPair>(_loc8_,true);
                     _loc6_[_loc7_] = _loc9_;
                     _loc10_ = 0;
                     while(_loc10_ < _loc8_)
                     {
                        _loc9_[_loc10_] = BooleanPair(this.elementCodec.decode(param1));
                        _loc10_++;
                     }
                  }
                  _loc7_++;
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:Vector.<Vector.<Vector.<BooleanPair>>> = Vector.<Vector.<Vector.<BooleanPair>>>(param2);
