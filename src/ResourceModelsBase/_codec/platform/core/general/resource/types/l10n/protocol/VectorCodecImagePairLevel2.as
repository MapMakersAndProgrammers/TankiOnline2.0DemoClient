package _codec.platform.core.general.resource.types.l10n.protocol
{
   ...
   public class VectorCodecImagePairLevel2 implements ICodec
   {
      ...
      public function VectorCodecImagePairLevel2(param1:Boolean)
      {
         super();
      ...
      {
         var _loc5_:int = 0;
         var _loc6_:Vector.<ImagePair> = null;
         var _loc7_:int = 0;
         var _loc2_:int = int(LengthCodecHelper.decodeLength(param1));
         var _loc3_:Vector.<Vector.<ImagePair>> = new Vector.<Vector.<ImagePair>>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            if(!param1.optionalMap.get())
            {
               ...
               _loc6_ = new Vector.<ImagePair>(_loc5_,true);
               _loc3_[_loc4_] = _loc6_;
               _loc7_ = 0;
               while(_loc7_ < _loc5_)
               {
                  _loc6_[_loc7_] = ImagePair(this.elementCodec.decode(param1));
                  _loc7_++;
               }
            }
            _loc4_++;
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:Vector.<Vector.<ImagePair>> = Vector.<Vector.<ImagePair>>(param2);
