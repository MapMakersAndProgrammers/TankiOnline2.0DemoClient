package _codec.platform.core.general.resource.types.l10n.protocol
{
   ...
   public class CodecDoublePair implements ICodec
   {
      ...
      public function CodecDoublePair()
      {
         super();
      }
      ...
      public function init(param1:IProtocol) : void
      {
         ...
         this.codec_value = param1.getCodec(new TypeCodecInfo(Number,false));
      }
      
      public function decode(param1:ProtocolBuffer) : Object
      {
         var _loc2_:String = this.codec_key.decode(param1) as String;
         var _loc3_:Number = this.codec_value.decode(param1) as Number;
         return new DoublePair(_loc2_,_loc3_);
      }
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:DoublePair = DoublePair(param2);
