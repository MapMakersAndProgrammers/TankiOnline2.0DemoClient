package _codec.platform.core.general.resource.types.l10n.protocol
{
   ...
   public class VectorCodecLocaleStructLevel3 implements ICodec
   {
      ...
      public function VectorCodecLocaleStructLevel3(param1:Boolean)
      {
         super();
      ...
      {
         this.elementCodec = param1.getCodec(new TypeCodecInfo(LocaleStruct,false));
      ...
      {
         var _loc5_:int = 0;
         var _loc6_:Vector.<Vector.<LocaleStruct>> = null;
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:Vector.<LocaleStruct> = null;
         var _loc10_:int = 0;
         var _loc2_:int = int(LengthCodecHelper.decodeLength(param1));
         var _loc3_:Vector.<Vector.<Vector.<LocaleStruct>>> = new Vector.<Vector.<Vector.<LocaleStruct>>>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            if(!param1.optionalMap.get())
            {
               ...
               _loc6_ = new Vector.<Vector.<LocaleStruct>>(_loc5_,true);
               ...
               while(_loc7_ < _loc5_)
               {
                  if(!param1.optionalMap.get())
                  {
                     ...
                     _loc9_ = new Vector.<LocaleStruct>(_loc8_,true);
                     _loc6_[_loc7_] = _loc9_;
                     _loc10_ = 0;
                     while(_loc10_ < _loc8_)
                     {
                        _loc9_[_loc10_] = LocaleStruct(this.elementCodec.decode(param1));
                        _loc10_++;
                     }
                  }
                  _loc7_++;
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:Vector.<Vector.<Vector.<LocaleStruct>>> = Vector.<Vector.<Vector.<LocaleStruct>>>(param2);
