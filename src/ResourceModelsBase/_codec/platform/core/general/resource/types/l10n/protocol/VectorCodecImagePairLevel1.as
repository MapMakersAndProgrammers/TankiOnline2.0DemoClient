package _codec.platform.core.general.resource.types.l10n.protocol
{
   ...
   public class VectorCodecImagePairLevel1 implements ICodec
   {
      ...
      public function decode(param1:ProtocolBuffer) : Object
      {
         ...
         var _loc3_:Vector.<ImagePair> = new Vector.<ImagePair>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            _loc3_[_loc4_] = ImagePair(this.elementCodec.decode(param1));
            _loc4_++;
         }
         return _loc3_;
      }
      ...
      {
         var _loc4_:ImagePair = null;
         if(param2 == null)
         {
            throw new Error("Object is null. Use @ProtocolOptional annotation.");
         }
         var _loc3_:Vector.<ImagePair> = Vector.<ImagePair>(param2);
