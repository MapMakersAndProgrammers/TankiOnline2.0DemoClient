package _codec.platform.core.general.resource.types.l10n.protocol
{
   ...
   public class CodecBooleanPair implements ICodec
   {
      ...
      public function CodecBooleanPair()
      {
         super();
      }
      ...
      public function init(param1:IProtocol) : void
      {
         ...
         this.codec_value = param1.getCodec(new TypeCodecInfo(Boolean,false));
      }
      
      public function decode(param1:ProtocolBuffer) : Object
      {
         var _loc2_:String = this.codec_key.decode(param1) as String;
         var _loc3_:Boolean = this.codec_value.decode(param1) as Boolean;
         return new BooleanPair(_loc2_,_loc3_);
      }
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:BooleanPair = BooleanPair(param2);
