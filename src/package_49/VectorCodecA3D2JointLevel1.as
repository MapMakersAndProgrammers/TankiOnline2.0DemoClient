package package_49
{
   ...
   public class VectorCodecA3D2JointLevel1 implements name_152
   {
      private var elementCodec:name_152;
      
      private var optionalElement:Boolean;
      
      public function VectorCodecA3D2JointLevel1(optionalElement:Boolean)
      {
         super();
      ...
      public function method_296(protocolBuffer:name_442) : Object
      {
         ...
         var result:Vector.<A3D2Joint> = new Vector.<A3D2Joint>(length,true);
         for(var i:int = 0; i < length; i++)
         {
            result[i] = A3D2Joint(this.elementCodec.method_296(protocolBuffer));
         }
         return result;
      }
      ...
      public function method_295(protocolBuffer:name_442, object:Object) : void
      {
         ...
         var data:Vector.<A3D2Joint> = Vector.<A3D2Joint>(object);
