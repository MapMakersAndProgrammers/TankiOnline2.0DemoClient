package package_49
{
   ...
   public class VectorCodecA3D2BoxLevel1 implements name_152
   {
      private var elementCodec:name_152;
      
      private var optionalElement:Boolean;
      
      public function VectorCodecA3D2BoxLevel1(optionalElement:Boolean)
      {
         super();
      ...
      public function method_296(protocolBuffer:name_442) : Object
      {
         ...
         var result:Vector.<A3D2Box> = new Vector.<A3D2Box>(length,true);
         for(var i:int = 0; i < length; i++)
         {
            result[i] = A3D2Box(this.elementCodec.method_296(protocolBuffer));
         }
         return result;
      }
      ...
      public function method_295(protocolBuffer:name_442, object:Object) : void
      {
         ...
         var data:Vector.<A3D2Box> = Vector.<A3D2Box>(object);
