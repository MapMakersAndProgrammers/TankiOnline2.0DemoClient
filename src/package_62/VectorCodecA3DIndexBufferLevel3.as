package package_62
{
   ...
   public class VectorCodecA3DIndexBufferLevel3 implements name_152
   {
      ...
      {
         this.elementCodec = protocol.name_448(new name_148(A3DIndexBuffer,false));
            ...
            if(!protocolBuffer.optionalMap.name_447())
            {
               ...
               for(i2 = 0; i2 < length2; )
               {
                  if(!protocolBuffer.optionalMap.name_447())
                  {
                     ...
                     {
                        items3[i3] = A3DIndexBuffer(this.elementCodec.method_296(protocolBuffer));
                     }
                  }
                  i2++;
               }
