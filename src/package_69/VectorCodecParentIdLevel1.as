package package_69
{
   ...
   public class VectorCodecParentIdLevel1 implements name_152
   {
      ...
      public function method_296(protocolBuffer:name_442) : Object
      {
         ...
         var result:Vector.<name_212> = new Vector.<name_212>(length,true);
         for(var i:int = 0; i < length; i++)
         {
            result[i] = name_212(this.elementCodec.method_296(protocolBuffer));
         }
         return result;
      }
      ...
      public function method_295(protocolBuffer:name_442, object:Object) : void
      {
         ...
         var data:Vector.<name_212> = Vector.<name_212>(object);
