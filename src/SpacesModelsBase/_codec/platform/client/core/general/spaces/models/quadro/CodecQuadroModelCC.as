package _codec.platform.client.core.general.spaces.models.quadro
{
   ...
   public class CodecQuadroModelCC implements ICodec
   {
      ...
      public function CodecQuadroModelCC()
      {
         super();
      }
      ...
      public function decode(param1:ProtocolBuffer) : Object
      {
         ...
         log.log("codec","struct %1 field %2 value %3","platform.client.core.general.spaces.models.quadro.QuadroModelCC","imageType",_loc2_);
         var _loc3_:Vector.<String> = this.codec_listString.decode(param1) as Vector.<String>;
         log.log("codec","struct %1 field %2 value %3","platform.client.core.general.spaces.models.quadro.QuadroModelCC","listString",_loc3_);
         var _loc4_:String = this.codec_name.decode(param1) as String;
         log.log("codec","struct %1 field %2 value %3","platform.client.core.general.spaces.models.quadro.QuadroModelCC","name",_loc4_);
         return new QuadroModelCC(_loc2_,_loc3_,_loc4_);
      }
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:QuadroModelCC = QuadroModelCC(param2);
