package _codec.platform.client.core.general.spaces.models.dispatcher
{
   ...
   public class VectorCodecModelDataLevel2 implements ICodec
   {
      ...
      public function VectorCodecModelDataLevel2(param1:Boolean)
      {
         super();
      ...
      {
         var _loc5_:int = 0;
         var _loc6_:Vector.<ModelData> = null;
         var _loc7_:int = 0;
         var _loc2_:int = int(LengthCodecHelper.decodeLength(param1));
         var _loc3_:Vector.<Vector.<ModelData>> = new Vector.<Vector.<ModelData>>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            if(!param1.optionalMap.get())
            {
               ...
               _loc6_ = new Vector.<ModelData>(_loc5_,true);
               _loc3_[_loc4_] = _loc6_;
               _loc7_ = 0;
               while(_loc7_ < _loc5_)
               {
                  _loc6_[_loc7_] = ModelData(this.elementCodec.decode(param1));
                  _loc7_++;
               }
            }
            _loc4_++;
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:Vector.<Vector.<ModelData>> = Vector.<Vector.<ModelData>>(param2);
