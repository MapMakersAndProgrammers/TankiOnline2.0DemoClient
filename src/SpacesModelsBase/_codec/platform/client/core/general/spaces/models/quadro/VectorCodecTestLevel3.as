package _codec.platform.client.core.general.spaces.models.quadro
{
   ...
   public class VectorCodecTestLevel3 implements ICodec
   {
      ...
      public function VectorCodecTestLevel3(param1:Boolean)
      {
         super();
      ...
      {
         var _loc5_:int = 0;
         var _loc6_:Vector.<Vector.<Test>> = null;
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:Vector.<Test> = null;
         var _loc10_:int = 0;
         var _loc2_:int = int(LengthCodecHelper.decodeLength(param1));
         var _loc3_:Vector.<Vector.<Vector.<Test>>> = new Vector.<Vector.<Vector.<Test>>>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            if(!param1.optionalMap.get())
            {
               ...
               _loc6_ = new Vector.<Vector.<Test>>(_loc5_,true);
               ...
               while(_loc7_ < _loc5_)
               {
                  if(!param1.optionalMap.get())
                  {
                     ...
                     _loc9_ = new Vector.<Test>(_loc8_,true);
                     _loc6_[_loc7_] = _loc9_;
                     _loc10_ = 0;
                     while(_loc10_ < _loc8_)
                     {
                        _loc9_[_loc10_] = Test(this.elementCodec.decode(param1));
                        _loc10_++;
                     }
                  }
                  _loc7_++;
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:Vector.<Vector.<Vector.<Test>>> = Vector.<Vector.<Vector.<Test>>>(param2);
