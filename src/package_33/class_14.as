package package_33
{
   ...
   import package_9.name_319;
   
   use namespace alternativa3d;
   
   public class class_14 extends Sprite
   {
      private static var drawDistanceFragment:name_119;
      
      private static var drawDistanceVertexProcedure:name_116;
      ...
      private static const drawUnit:name_123 = new name_123();
      ...
      private static const branch:Vector.<name_130> = new Vector.<name_130>();
      
      private static const overedBranch:Vector.<name_130> = new Vector.<name_130>();
      
      private static const changedBranch:Vector.<name_130> = new Vector.<name_130>();
      ...
      private var surfaces:Vector.<name_134>;
      
      private var geometries:Vector.<name_136>;
      
      private var var_128:Vector.<name_116>;
      ...
      private var var_121:Vector.<Vector.<name_134>>;
      ...
      private var target:name_130;
      
      private var targetSurface:name_134;
      
      private var var_122:Number;
      
      private var var_123:name_130;
      
      private var var_129:name_130;
      
      private var var_116:name_130;
      
      private var var_131:name_134;
      ...
      public function class_14(width:int, height:int, renderToBitmap:Boolean = false, backgroundColor:uint = 0, backgroundAlpha:Number = 1, antiAlias:int = 0)
      {
         var item:ContextMenuItem;
         var menu:ContextMenu;
         this.var_117 = new Vector.<MouseEvent>();
         this.indices = new Vector.<int>();
         this.surfaces = new Vector.<name_134>();
         this.geometries = new Vector.<name_136>();
         this.var_128 = new Vector.<name_116>();
         ...
         this.var_121 = new Vector.<Vector.<name_134>>();
         ...
         tabEnabled = false;
         tabChildren = false;
         item = new ContextMenuItem("Powered by Alternativa3D " + name_319.version);
         ...
         {
            drawDistanceVertexProcedure = name_116.name_144(["#v0=distance","#c0=transform0","#c1=transform1","#c2=transform2","#c3=coefficient","#c4=projection","dp4 t0.x, i0, c0","dp4 t0.y, i0, c1","dp4 t0.z, i0, c2","mul v0.x, t0.z, c3.z","mov v0.y, i0.x","mov v0.z, i0.x","mov v0.w, i0.x","mul t1.x, t0.x, c4.x","mul t1.y, t0.y, c4.y","mul t0.w, t0.z, c4.z","add t1.z, t0.w, c4.w","mov t3.z, c4.x","div t3.z, t3.z, c4.x","sub t3.z, t3.z, c3.w","mul t1.w, t0.z, t3.z","add t1.w, t1.w, c3.w","mul t0.x, c3.x, t1.w","mul t0.y, c3.y, t1.w","add t1.x, t1.x, t0.x","add t1.y, t1.y, t0.y","mov o0, t1"],"mouseEventsVertex");
            drawDistanceFragment = new name_119(Context3DProgramType.FRAGMENT);
            drawDistanceFragment.name_120(new name_116(["mov t0.z, c0.z","mov t0.w, c0.w","frc t0.y, v0.x","sub t0.x, v0.x, t0.y","mul t0.x, t0.x, c0.x","mov o0, ft0","#v0=distance","#c0=code"],"mouseEventsFragment"));
         }
         addEventListener(MouseEvent.MOUSE_DOWN,this.method_107);
         addEventListener(MouseEvent.CLICK,this.method_107);
         addEventListener(MouseEvent.DOUBLE_CLICK,this.method_107);
         addEventListener(MouseEvent.MOUSE_MOVE,this.method_107);
         addEventListener(MouseEvent.MOUSE_OVER,this.method_107);
         addEventListener(MouseEvent.MOUSE_WHEEL,this.method_107);
         addEventListener(MouseEvent.MOUSE_OUT,this.method_116);
      ...
      private function method_26(e:Event) : void
      {
         ...
         stage.addEventListener(KeyboardEvent.KEY_UP,this.method_111);
      }
      
      private function method_25(e:Event) : void
      {
         stage.removeEventListener(KeyboardEvent.KEY_DOWN,this.method_14);
         stage.removeEventListener(KeyboardEvent.KEY_UP,this.method_111);
         this.altKey = false;
         this.ctrlKey = false;
         this.shiftKey = false;
      }
      
      private function method_14(keyboardEvent:KeyboardEvent) : void
      {
         ...
         if(this.ctrlKey && this.shiftKey && keyboardEvent.keyCode == Keyboard.F1 && this.var_118 == null)
         {
            ...
            setTimeout(this.method_119,2048);
         }
      }
      
      private function method_111(keyboardEvent:KeyboardEvent) : void
      {
         this.altKey = keyboardEvent.altKey;
         this.ctrlKey = keyboardEvent.ctrlKey;
         this.shiftKey = keyboardEvent.shiftKey;
      ...
      alternativa3d function calculateRays(camera:name_135) : void
      {
         var i:int = 0;
            ...
            if(mouseEvent.type != "mouseOut")
            {
               if(mouseEvent.localX != mouseX || mouseEvent.localY != mouseY)
               {
                  ...
                  else
                  {
                     ...
                     this.var_121[this.alternativa3d::raysLength] = new Vector.<name_134>();
      ...
      alternativa3d function method_124(surface:name_134, geometry:name_136, procedure:name_116) : void
      {
      ...
      alternativa3d function method_122(stage3D:Stage3D, context:Context3D) : void
      {
      ...
      alternativa3d function method_121(context:Context3D, camera:name_135) : void
      {
         var i:int = 0;
         var raySurfaces:Vector.<name_134> = null;
         ...
         if(this.var_113 > 0)
         {
            if(this.var_115 > 0)
            {
               this.method_114(context,camera,this.alternativa3d::var_110,this.alternativa3d::_height);
            ...
            for(i = 0; i < this.var_113; i++)
            {
               ...
               {
                  case "mouseDown":
                     this.method_106(index);
                     if(this.target != null)
                     {
                        this.method_104(MouseEvent3D.MOUSE_DOWN,mouseEvent,camera,this.target,this.targetSurface,this.method_105(this.target,branch));
                     }
                  ...
                  case "mouseWheel":
                     ...
                     if(this.target != null)
                     {
                        this.method_104(MouseEvent3D.MOUSE_WHEEL,mouseEvent,camera,this.target,this.targetSurface,this.method_105(this.target,branch));
                     }
                     break;
                  case "click":
                     this.method_106(index);
                     if(this.target != null)
                     {
                        this.method_104(MouseEvent3D.MOUSE_UP,mouseEvent,camera,this.target,this.targetSurface,this.method_105(this.target,branch));
                        if(this.var_123 == this.target)
                        {
                           this.var_129 = this.target;
                           this.method_104(MouseEvent3D.CLICK,mouseEvent,camera,this.target,this.targetSurface,this.method_105(this.target,branch));
                        }
                     }
                     this.var_123 = null;
                     break;
                  case "doubleClick":
                     ...
                     if(this.target != null)
                     {
                        ...
                        if(this.var_123 == this.target)
                        {
                           this.method_104(this.var_129 == this.target && Boolean(this.target.doubleClickEnabled) ? MouseEvent3D.DOUBLE_CLICK : MouseEvent3D.CLICK,mouseEvent,camera,this.target,this.targetSurface,this.method_105(this.target,branch));
                        }
                     }
                     this.var_129 = null;
                     this.var_123 = null;
                  ...
                  case "mouseMove":
                     ...
                     if(this.target != null)
                     {
                        this.method_104(MouseEvent3D.MOUSE_MOVE,mouseEvent,camera,this.target,this.targetSurface,this.method_105(this.target,branch));
                     }
                     if(this.var_116 != this.target)
                     {
                        this.method_109(mouseEvent,camera);
                     }
                     break;
                  case "mouseOut":
                     this.var_119 = null;
      ...
      private function method_114(context:Context3D, camera:name_135, contextWidth:int, contextHeight:int) : void
      {
         var vLinker:name_119 = null;
         var fLinker:name_119 = null;
         var i:int = 0;
         var j:int = 0;
         var log2Width:int = 0;
         ...
         var drawRectGeometry:name_136 = drawRectGeometries[context];
         if(drawRectGeometry == null)
         {
            drawRectGeometry = new name_136(4);
            drawRectGeometry.addVertexStream([name_117.POSITION,name_117.POSITION,name_117.POSITION,name_117.TEXCOORDS[0],name_117.TEXCOORDS[0]]);
            drawRectGeometry.setAttributeValues(name_117.POSITION,Vector.<Number>([0,0,1,0,1,1,1,1,1,1,0,1]));
            drawRectGeometry.setAttributeValues(name_117.TEXCOORDS[0],Vector.<Number>([0,0,0,1,1,1,1,0]));
         ...
         var drawColoredRectProgram:class_6 = drawColoredRectPrograms[context];
         if(drawColoredRectProgram == null)
         {
            vLinker = new name_119(Context3DProgramType.VERTEX);
            vLinker.name_120(name_116.name_144(["#a0=a0","#c0=c0","mul t0.x, a0.x, c0.x","mul t0.y, a0.y, c0.y","add o0.x, t0.x, c0.z","add o0.y, t0.y, c0.w","mov o0.z, a0.z","mov o0.w, a0.z"]));
            fLinker = new name_119(Context3DProgramType.FRAGMENT);
            fLinker.name_120(name_116.name_144(["#c0=c0","mov o0, c0"]));
            drawColoredRectProgram = new class_6(vLinker,fLinker);
            drawColoredRectProgram.upload(context);
            drawColoredRectPrograms[context] = drawColoredRectProgram;
         }
         var drawTexturedRectProgram:class_6 = drawTexturedRectPrograms[context];
         if(drawTexturedRectProgram == null)
         {
            vLinker = new name_119(Context3DProgramType.VERTEX);
            vLinker.name_120(name_116.name_144(["#a0=a0","#a1=a1","#v0=v0","#c0=c0","#c1=c1","mul v0, a1, c1","mul t0.x, a0.x, c0.x","mul t0.y, a0.y, c0.y","add o0.x, t0.x, c0.z","add o0.y, t0.y, c0.w","mov o0.z, a0.z","mov o0.w, a0.z"]));
            fLinker = new name_119(Context3DProgramType.FRAGMENT);
            fLinker.name_120(name_116.name_144(["#v0=v0","#s0=s0","tex t0, v0, s0 <2d, nearest, mipnone>","mov o0, t0"]));
            drawTexturedRectProgram = new class_6(vLinker,fLinker);
            ...
            for(j = 0; j < this.var_115; )
            {
               if(pixelIndex == 0)
               {
                  ...
                  else
                  {
                     ...
                     context.setVertexBufferAt(0,drawRectGeometry.alternativa3d::getVertexBuffer(name_117.POSITION),drawRectGeometry.alternativa3d::_attributesOffsets[name_117.POSITION],name_117.alternativa3d::FORMATS[name_117.POSITION]);
                     ...
                     context.drawTriangles(drawRectGeometry.alternativa3d::name_78,0,2);
                     context.setVertexBufferAt(0,null);
                  }
               }
               scissor.x = pixelIndex;
               context.setScissorRectangle(scissor);
               this.method_115(context,camera,j,m0,m5,m10,m11,(pixelIndex * 2 / contextWidth - rayCoefficients.x) * drawTextureWidthScale + drawTextureWidthOffset,rayCoefficients.y * drawTextureHeightScale - drawTextureHeightOffset,kZ,fragmentConst,camera.orthographic);
               ...
               if(pixelIndex >= contextWidth || i >= this.alternativa3d::raysLength && j >= this.var_115)
               {
                  if(this.antiAlias > 0)
                  {
                     ...
                     context.setVertexBufferAt(0,drawRectGeometry.alternativa3d::getVertexBuffer(name_117.POSITION),drawRectGeometry.alternativa3d::_attributesOffsets[name_117.POSITION],name_117.alternativa3d::FORMATS[name_117.POSITION]);
                     context.setVertexBufferAt(1,drawRectGeometry.alternativa3d::getVertexBuffer(name_117.TEXCOORDS[0]),drawRectGeometry.alternativa3d::_attributesOffsets[name_117.TEXCOORDS[0]],name_117.alternativa3d::FORMATS[name_117.TEXCOORDS[0]]);
                     context.setProgramConstantsFromVector(Context3DProgramType.VERTEX,0,drawColoredRectConst);
      ...
      private function method_115(context:Context3D, camera:name_135, index:int, m0:Number, m5:Number, m10:Number, m14:Number, xOffset:Number, yOffset:Number, vertexConst:Number, fragmentConst:Number, orthographic:Boolean) : void
      {
         var i:int = 0;
         var vertex:name_119 = null;
         var position:String = null;
         var surface:name_134 = this.surfaces[index];
         var geometry:name_136 = this.geometries[index];
         var procedure:name_116 = this.var_128[index];
         var object:name_130 = surface.alternativa3d::object;
         var drawDistanceProgram:class_6 = drawDistancePrograms[procedure];
         if(drawDistanceProgram == null)
         {
            vertex = new name_119(Context3DProgramType.VERTEX);
            position = "position";
            vertex.name_125(position,name_128.ATTRIBUTE);
            if(procedure != null)
            {
               vertex.name_120(procedure);
               vertex.name_125("localPosition",name_128.TEMPORARY);
               vertex.name_122(procedure,position);
               vertex.name_127(procedure,"localPosition");
               position = "localPosition";
            }
            vertex.name_120(drawDistanceVertexProcedure);
            vertex.name_122(drawDistanceVertexProcedure,position);
            drawDistanceProgram = new class_6(vertex,drawDistanceFragment);
            drawDistanceFragment.name_140(vertex);
            drawDistanceProgram.upload(context);
            drawDistancePrograms[procedure] = drawDistanceProgram;
         }
         var buffer:VertexBuffer3D = geometry.alternativa3d::getVertexBuffer(name_117.POSITION);
         if(buffer == null)
         {
            return;
         }
         drawUnit.alternativa3d::name_316 = 0;
         drawUnit.alternativa3d::name_317 = 0;
         drawUnit.alternativa3d::name_320 = 0;
         object.alternativa3d::setTransformConstants(drawUnit,surface,drawDistanceProgram.vertexShader,camera);
         drawUnit.alternativa3d::name_325(drawDistanceProgram.vertexShader.getVariableIndex("transform0"),object.alternativa3d::localToCameraTransform);
         drawUnit.alternativa3d::name_143(drawDistanceProgram.vertexShader.getVariableIndex("coefficient"),xOffset,yOffset,vertexConst,orthographic ? 1 : 0);
         drawUnit.alternativa3d::name_143(drawDistanceProgram.vertexShader.getVariableIndex("projection"),m0,m5,m10,m14);
         drawUnit.alternativa3d::name_124(drawDistanceProgram.fragmentShader.getVariableIndex("code"),fragmentConst,0,0,1);
         context.setProgram(drawDistanceProgram.program);
         context.setVertexBufferAt(0,buffer,geometry.alternativa3d::_attributesOffsets[name_117.POSITION],name_117.alternativa3d::FORMATS[name_117.POSITION]);
         for(i = 0; i < drawUnit.alternativa3d::name_316; i++)
         {
            context.setVertexBufferAt(drawUnit.alternativa3d::name_318[i],drawUnit.alternativa3d::vertexBuffers[i],drawUnit.alternativa3d::name_324[i],drawUnit.alternativa3d::name_322[i]);
         }
         ...
         context.drawTriangles(geometry.alternativa3d::name_78,surface.indexBegin,surface.numTriangles);
         context.setVertexBufferAt(0,null);
         for(i = 0; i < drawUnit.alternativa3d::name_316; i++)
         {
            context.setVertexBufferAt(drawUnit.alternativa3d::name_318[i],null);
         }
      }
      
      private function sort(surfaces:Vector.<name_134>, depths:Vector.<Number>, length:int) : void
      {
         var r:int = 0;
         var j:int = 0;
         var l:int = 0;
      ...
      private function method_109(mouseEvent:MouseEvent, camera:name_135) : void
      {
         var changedBranchLength:int = 0;
         var i:int = 0;
         var j:int = 0;
         var object:name_130 = null;
         this.method_105(this.target,branch);
         this.method_105(this.var_116,overedBranch);
         var branchLength:int = int(branch.length);
         var overedBranchLength:int = int(overedBranch.length);
         if(this.var_116 != null)
         {
            this.method_104(MouseEvent3D.MOUSE_OUT,mouseEvent,camera,this.var_116,this.var_131,overedBranch,true,this.target);
            ...
            if(changedBranchLength > 0)
            {
               ...
               this.method_104(MouseEvent3D.ROLL_OUT,mouseEvent,camera,this.var_116,this.var_131,changedBranch,false,this.target);
            }
         }
         if(this.target != null)
         {
            ...
            {
               changedBranch.length = changedBranchLength;
               this.method_104(MouseEvent3D.ROLL_OVER,mouseEvent,camera,this.target,this.targetSurface,changedBranch,false,this.var_116);
            }
            this.method_104(MouseEvent3D.MOUSE_OVER,mouseEvent,camera,this.target,this.targetSurface,branch,true,this.var_116);
      ...
      private function method_105(object:name_130, vector:Vector.<name_130>) : Vector.<name_130>
      {
      ...
      private function method_104(type:String, mouseEvent:MouseEvent, camera:name_135, target:name_130, targetSurface:name_134, objects:Vector.<name_130>, bubbles:Boolean = true, relatedObject:name_130 = null) : void
      {
         var object:name_130 = null;
         ...
         for(i = oblectsLength - 1; i > 0; )
         {
            ...
            if(object.alternativa3d::captureListeners != null)
            {
               ...
               if(vector != null)
               {
                  ...
                  {
                     this.method_112(camera,target.alternativa3d::cameraToLocalTransform,this.var_122,mouseEvent);
                     ...
                     mouseEvent3D.alternativa3d::name_314 = target;
                     mouseEvent3D.alternativa3d::var_109 = targetSurface;
                  }
                  mouseEvent3D.alternativa3d::name_313 = object;
                  mouseEvent3D.alternativa3d::name_312 = 1;
         ...
         for(i = 0; i < oblectsLength; )
         {
            ...
            if(object.alternativa3d::bubbleListeners != null)
            {
               ...
               if(vector != null)
               {
                  ...
                  mouseEvent3D.alternativa3d::name_313 = object;
                  mouseEvent3D.alternativa3d::name_312 = i == 0 ? 2 : 3;
                  length = int(vector.length);
                  for(j = 0; j < length; functions[j] = vector[j],j++)
                  {
                  }
      ...
      private function method_106(index:int) : void
      {
         var source:name_130 = null;
         var surface:name_134 = null;
         var depth:Number = NaN;
         var object:name_130 = null;
         var potentialTarget:name_130 = null;
         var obj:name_130 = null;
         var surfaces:Vector.<name_134> = this.var_121[index];
         ...
         for(var i:int = surfaces.length - 1; i >= 0; )
         {
            ...
            for(obj = object; obj != null; )
            {
               ...
               if(potentialTarget == null && Boolean(obj.mouseEnabled))
               {
                  potentialTarget = obj;
               }
      ...
      public function method_123() : void
      {
         if(this.var_112 != null)
         {
      ...
      public function get method_118() : String
      {
         return this.var_111;
      }
      
      public function set method_118(value:String) : void
      {
         this.var_111 = value;
         this.method_108();
      }
      ...
      public function set method_117(value:Number) : void
      {
         this.var_126 = value;
         this.method_108();
      }
      
      public function get method_113() : Number
      {
         return this.var_125;
      }
      
      public function set method_113(value:Number) : void
      {
         this.var_125 = value;
         this.method_108();
      }
