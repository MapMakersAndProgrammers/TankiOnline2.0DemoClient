package package_48
{
   ...
   public class A3D2OmniLight
   {
      ...
      public function A3D2OmniLight(attenuationBegin:Number, attenuationEnd:Number, boundBoxId:int, color:uint, id:name_155, intensity:Number, name:String, parentId:name_155, transform:A3D2Transform, visible:Boolean)
      {
         super();
