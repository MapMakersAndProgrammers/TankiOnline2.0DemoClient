package package_48
{
   ...
   public class A3D2DirectionalLight
   {
      ...
      public function A3D2DirectionalLight(boundBoxId:int, color:uint, id:name_155, intensity:Number, name:String, parentId:name_155, transform:A3D2Transform, visible:Boolean)
      {
         super();
