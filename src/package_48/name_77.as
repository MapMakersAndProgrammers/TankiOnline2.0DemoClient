package package_48
{
   ...
   public class name_77
   {
      ...
      public var boundBox:name_334;
      
      alternativa3d var next:name_77;
      
      alternativa3d var name_326:name_77;
      
      alternativa3d var system:name_336;
      ...
      alternativa3d var aabb:name_334;
      ...
      {
         var i:int = 0;
         this.alternativa3d::aabb = new name_334();
      ...
      public function set position(value:Vector3D) : void
      {
         ...
         {
            this.alternativa3d::name_329(this.alternativa3d::system.alternativa3d::name_335() - this.alternativa3d::startTime);
         }
      }
      ...
      public function set direction(value:Vector3D) : void
      {
         ...
         if(this.alternativa3d::system != null)
         {
            this.alternativa3d::name_327(this.alternativa3d::system.alternativa3d::name_335() - this.alternativa3d::startTime);
         }
      }
      
      public function stop() : void
      {
         var time:Number = this.alternativa3d::system.alternativa3d::name_335() - this.alternativa3d::startTime;
      ...
      protected function get var_6() : name_336
      {
         return this.alternativa3d::system;
      }
      
      protected function get method_125() : name_129
      {
      ...
      protected function method_126(time:Number, script:Function) : void
      {
      ...
      protected function method_127(time:Number) : void
      {
      ...
      alternativa3d function name_329(time:Number) : void
      {
      ...
      alternativa3d function name_327(time:Number) : void
      {
      ...
      alternativa3d function name_328(time:Number) : Boolean
      {
