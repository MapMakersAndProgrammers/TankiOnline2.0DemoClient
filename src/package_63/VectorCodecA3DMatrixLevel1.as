package package_63
{
   ...
   public class VectorCodecA3DMatrixLevel1 implements name_152
   {
      ...
      public function method_296(protocolBuffer:name_442) : Object
      {
         ...
         var result:Vector.<name_214> = new Vector.<name_214>(length,true);
         for(var i:int = 0; i < length; i++)
         {
            result[i] = name_214(this.elementCodec.method_296(protocolBuffer));
         }
         return result;
      }
      ...
      public function method_295(protocolBuffer:name_442, object:Object) : void
      {
         ...
         var data:Vector.<name_214> = Vector.<name_214>(object);
