package _codec.platform.client.fp10.core.type
{
   ...
   public class VectorCodecIGameObjectLevel2 implements ICodec
   {
      ...
      public function VectorCodecIGameObjectLevel2(param1:Boolean)
      {
         super();
      ...
      public function decode(param1:ProtocolBuffer) : Object
      {
         ...
         var _loc3_:Vector.<Vector.<IGameObject>> = new Vector.<Vector.<IGameObject>>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            if(!param1.optionalMap.get())
            {
               ...
               _loc6_ = new Vector.<IGameObject>(_loc5_,true);
               _loc3_[_loc4_] = _loc6_;
               _loc7_ = 0;
               while(_loc7_ < _loc5_)
               {
                  _loc6_[_loc7_] = IGameObject(this.elementCodec.decode(param1));
                  _loc7_++;
               }
            }
            _loc4_++;
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:Vector.<Vector.<IGameObject>> = Vector.<Vector.<IGameObject>>(param2);
