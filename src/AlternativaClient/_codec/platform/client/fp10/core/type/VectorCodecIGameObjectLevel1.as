package _codec.platform.client.fp10.core.type
{
   ...
   public class VectorCodecIGameObjectLevel1 implements ICodec
   {
      ...
      public function decode(param1:ProtocolBuffer) : Object
      {
         ...
         var _loc3_:Vector.<IGameObject> = new Vector.<IGameObject>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            _loc3_[_loc4_] = IGameObject(this.elementCodec.decode(param1));
            _loc4_++;
         }
         return _loc3_;
      }
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:Vector.<IGameObject> = Vector.<IGameObject>(param2);
