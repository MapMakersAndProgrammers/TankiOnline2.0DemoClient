package _codec.platform.client.fp10.core.resource.types
{
   ...
   public class VectorCodecMultiframeImageResourceLevel1 implements ICodec
   {
      ...
      public function VectorCodecMultiframeImageResourceLevel1(param1:Boolean)
      {
         super();
      ...
      {
         var _loc4_:MultiframeImageResource = null;
         if(param2 == null)
         {
            throw new Error("Object is null. Use @ProtocolOptional annotation.");
         }
         var _loc3_:Vector.<MultiframeImageResource> = Vector.<MultiframeImageResource>(param2);
