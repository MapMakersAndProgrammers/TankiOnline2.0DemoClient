package platform.client.fp10.core.model.impl
{
   ...
   public class Model implements IModel
   {
      ...
      {
         return GameObject(currentObject).getData(this,param1);
      }
      
      public function putData(param1:Class, param2:Object) : void
      {
         GameObject(currentObject).putData(this,param1,param2);
      }
      
      public function clearData(param1:Class) : Object
      {
         return GameObject(currentObject).clearData(this,param1);
      }
