package _codec.versions.version2.a3d.objects
{
   ...
   public class VectorCodecA3D2SkinLevel3 implements ICodec
   {
      ...
      {
         this.elementCodec = protocol.getCodec(new TypeCodecInfo(A3D2Skin,false));
            ...
            if(!protocolBuffer.optionalMap.get())
            {
               ...
               for(i2 = 0; i2 < length2; )
               {
                  if(!protocolBuffer.optionalMap.get())
                  {
                     ...
                     {
                        items3[i3] = A3D2Skin(this.elementCodec.decode(protocolBuffer));
                     }
                  }
                  i2++;
               }
