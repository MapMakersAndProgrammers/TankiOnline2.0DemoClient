package _codec.versions.version2.a3d.objects
{
   ...
   public class VectorCodecA3D2JointLevel3 implements ICodec
   {
      ...
      {
         this.elementCodec = protocol.getCodec(new TypeCodecInfo(A3D2Joint,false));
            ...
            if(!protocolBuffer.optionalMap.OptionalMap())
            {
               ...
               for(i2 = 0; i2 < length2; )
               {
                  if(!protocolBuffer.optionalMap.OptionalMap())
                  {
                     ...
                     {
                        items3[i3] = A3D2Joint(this.elementCodec.decode(protocolBuffer));
                     }
                  }
                  i2++;
               }
