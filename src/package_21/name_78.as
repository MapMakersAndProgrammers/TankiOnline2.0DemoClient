package package_21
{
   ...
   public class name_78 implements IEventDispatcher
   {
      protected static const trm:name_139 = new name_139();
      ...
      alternativa3d var _parent:name_78;
      
      alternativa3d var childrenList:name_78;
      
      alternativa3d var next:name_78;
      
      alternativa3d var transform:name_139 = new name_139();
      
      alternativa3d var inverseTransform:name_139 = new name_139();
      
      alternativa3d var transformChanged:Boolean = true;
      
      alternativa3d var cameraToLocalTransform:name_139 = new name_139();
      
      alternativa3d var localToCameraTransform:name_139 = new name_139();
      
      alternativa3d var localToGlobalTransform:name_139 = new name_139();
      
      alternativa3d var globalToLocalTransform:name_139 = new name_139();
      ...
      alternativa3d var transformProcedure:name_114;
      
      alternativa3d var deltaTransformProcedure:name_114;
      
      alternativa3d var shadowRenderers:Vector.<name_103>;
      
      alternativa3d var numShadowRenderers:int;
      
      public function name_78()
      {
         super();
      }
      ...
      public function intersectRay(origin:Vector3D, direction:Vector3D) : name_387
      {
         return this.alternativa3d::intersectRayChildren(origin,direction);
      }
      
      alternativa3d function intersectRayChildren(origin:Vector3D, direction:Vector3D) : name_387
      {
         var childOrigin:Vector3D = null;
         var childDirection:Vector3D = null;
         var childTransform:name_139 = null;
         var ma:Number = NaN;
         var mb:Number = NaN;
         var mc:Number = NaN;
         var md:Number = NaN;
         ...
         var minData:name_387 = null;
         for(var child:name_78 = this.alternativa3d::childrenList; child != null; )
         {
            if(childOrigin == null)
            {
      ...
      public function calculateBoundBox() : void
      {
         ...
         {
            this.boundBox = new name_386();
         }
         this.alternativa3d::updateBoundBox(this.boundBox,false,null);
      }
      
      alternativa3d function updateBoundBox(boundBox:name_386, hierarchy:Boolean, transform:name_139 = null) : void
      {
      ...
      {
         for(var object:name_78 = this; object != null; )
         {
      ...
      public function dispatchEvent(event:Event) : Boolean
      {
         ...
         if(event3D != null)
         {
            event3D.alternativa3d::name_394 = this;
         }
         var branch:Vector.<name_78> = new Vector.<name_78>();
         ...
         for(i = branchLength - 1; i > 0; )
         {
            ...
            if(event3D != null)
            {
               event3D.alternativa3d::name_390 = object;
               event3D.alternativa3d::name_388 = EventPhase.CAPTURING_PHASE;
            }
         ...
         if(event3D != null)
         {
            event3D.alternativa3d::name_388 = EventPhase.AT_TARGET;
         }
         for(i = 0; i < branchLength; )
         {
            ...
            if(event3D != null)
            {
               ...
               if(i > 0)
               {
                  event3D.alternativa3d::name_388 = EventPhase.BUBBLING_PHASE;
               }
            }
      ...
      public function get parent() : name_78
      {
      ...
      public function addChild(child:name_78) : name_78
      {
         if(child == null)
         {
      ...
      public function removeChild(child:name_78) : name_78
      {
         if(child == null)
         {
            throw new TypeError("Parameter child must be non-null.");
         ...
         var result:name_78 = this.removeFromList(child);
         if(result == null)
         {
      ...
      private function removeFromList(child:name_78) : name_78
      {
         var prev:name_78 = null;
         var current:name_78 = null;
      ...
      public function addChildAt(child:name_78, index:int) : name_78
      {
         if(child == null)
         {
            throw new TypeError("Parameter child must be non-null.");
         ...
         var current:name_78 = this.alternativa3d::childrenList;
      ...
      public function removeChildAt(index:int) : name_78
      {
         if(index < 0)
         {
            throw new RangeError("The supplied index is out of bounds.");
      ...
      public function getChildAt(index:int) : name_78
      {
         if(index < 0)
         {
            throw new RangeError("The supplied index is out of bounds.");
      ...
      public function getChildIndex(child:name_78) : int
      {
         if(child == null)
         {
            throw new TypeError("Parameter child must be non-null.");
         ...
         var index:int = 0;
         for(var current:name_78 = this.alternativa3d::childrenList; current != null; current = current.alternativa3d::next)
         {
            if(current == child)
            {
               return index;
      ...
      public function setChildIndex(child:name_78, index:int) : void
      {
         if(child == null)
         {
            throw new TypeError("Parameter child must be non-null.");
      ...
      public function swapChildren(child1:name_78, child2:name_78) : void
      {
         var nxt:name_78 = null;
      ...
      {
         var i:int = 0;
         var child1:name_78 = null;
         var child2:name_78 = null;
         var nxt:name_78 = null;
      ...
      public function getChildByName(name:String) : name_78
      {
         if(name == null)
         {
      ...
      public function contains(child:name_78) : Boolean
      {
         if(child == null)
         {
            throw new TypeError("Parameter child must be non-null.");
         ...
         for(var object:name_78 = this.alternativa3d::childrenList; object != null; )
         {
      ...
      {
         var num:int = 0;
         for(var current:name_78 = this.alternativa3d::childrenList; current != null; num++,current = current.alternativa3d::next)
         {
         }
         return num;
      }
      
      private function addToList(child:name_78, item:name_78 = null) : void
      {
         var current:name_78 = null;
         ...
         {
            for(current = this.alternativa3d::childrenList; current != null; )
            {
               if(current.alternativa3d::next == item)
               {
                  current.alternativa3d::next = child;
                  break;
               }
               current = current.alternativa3d::next;
            }
      ...
      public function getResources(hierarchy:Boolean = false, resourceType:Class = null) : Vector.<name_77>
      {
         var key:* = undefined;
      ...
      alternativa3d function calculateVisibility(camera:name_124) : void
      {
      }
      
      alternativa3d function calculateChildrenVisibility(camera:name_124) : void
      {
         for(var child:name_78 = this.alternativa3d::childrenList; child != null; )
         {
            if(child.visible)
            {
               ...
               if(child.boundBox != null)
               {
                  ...
                  child.alternativa3d::culling = child.boundBox.alternativa3d::name_393(camera.alternativa3d::frustum,63);
               }
               else
               {
      ...
      alternativa3d function collectDraws(camera:name_124, lights:Vector.<name_116>, lightsLength:int) : void
      {
      }
      
      alternativa3d function collectChildrenDraws(camera:name_124, lights:Vector.<name_116>, lightsLength:int) : void
      {
         var i:int = 0;
         ...
         for(var child:name_78 = this.alternativa3d::childrenList; child != null; )
         {
            if(child.visible)
            {
               ...
               if(child.alternativa3d::culling >= 0 && (child.boundBox == null || camera.alternativa3d::occludersLength == 0 || Boolean(child.boundBox.alternativa3d::name_392(camera,child))))
               {
                  if(child.alternativa3d::listening && child.boundBox != null)
                  {
                     ...
                     child.alternativa3d::listening = child.boundBox.alternativa3d::name_391(camera.alternativa3d::origins,camera.alternativa3d::directions,camera.alternativa3d::raysLength);
                  }
                  if(lightsLength > 0 && child.alternativa3d::useLights)
                  {
                     if(child.boundBox != null)
                     {
                        ...
                        {
                           light = lights[i];
                           light.alternativa3d::name_141.combine(child.alternativa3d::cameraToLocalTransform,light.alternativa3d::localToCameraTransform);
                           if(light.boundBox == null || Boolean(light.alternativa3d::checkBound(child)))
                           {
      ...
      alternativa3d function collectGeometry(collider:name_389, excludedObjects:Dictionary) : void
      {
      }
      
      alternativa3d function collectChildrenGeometry(collider:name_389, excludedObjects:Dictionary) : void
      {
         ...
         for(var child:name_78 = this.alternativa3d::childrenList; child != null; )
         {
            if(excludedObjects == null || !excludedObjects[child])
            {
               ...
               if(child.boundBox != null)
               {
                  collider.alternativa3d::name_396(child.alternativa3d::globalToLocalTransform);
                  intersects = Boolean(child.boundBox.alternativa3d::name_395(collider.alternativa3d::sphere));
               }
               if(intersects)
               {
      ...
      alternativa3d function setTransformConstants(drawUnit:name_135, surface:name_117, vertexShader:name_121, camera:name_124) : void
      {
      }
      
      public function clone() : name_78
      {
         var res:name_78 = new name_78();
         res.clonePropertiesFrom(this);
         return res;
      }
      
      protected function clonePropertiesFrom(source:name_78) : void
      {
         var lastChild:name_78 = null;
         var newChild:name_78 = null;
         ...
         for(var child:name_78 = source.alternativa3d::childrenList; child != null; child = child.alternativa3d::next)
         {
