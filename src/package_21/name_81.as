package package_21
{
   ...
   public class name_81 extends Sprite
   {
      private static var drawDistanceFragment:name_121;
      
      private static var drawDistanceVertexProcedure:name_114;
      ...
      private static const drawUnit:name_135 = new name_135();
      ...
      private static const branch:Vector.<name_78> = new Vector.<name_78>();
      
      private static const overedBranch:Vector.<name_78> = new Vector.<name_78>();
      
      private static const changedBranch:Vector.<name_78> = new Vector.<name_78>();
      ...
      alternativa3d var var_110:int;
      
      alternativa3d var _height:int;
      
      alternativa3d var var_114:BitmapData = null;
      
      private var var_117:Vector.<MouseEvent>;
      
      private var indices:Vector.<int>;
      
      private var var_113:int = 0;
      
      private var surfaces:Vector.<name_117>;
      
      private var geometries:Vector.<name_119>;
      
      private var var_128:Vector.<name_114>;
      
      private var var_115:int = 0;
      
      alternativa3d var var_127:Vector.<Vector3D>;
      
      alternativa3d var var_133:Vector.<Vector3D>;
      
      private var var_124:Vector.<Point>;
      
      private var var_121:Vector.<Vector.<name_117>>;
      
      private var var_120:Vector.<Vector.<Number>>;
      
      private var var_130:Vector.<int>;
      
      private var var_132:Vector.<int>;
      
      alternativa3d var raysLength:int = 0;
      
      private var var_119:MouseEvent;
      
      private var target:name_78;
      
      private var targetSurface:name_117;
      
      private var var_122:Number;
      
      private var var_123:name_78;
      
      private var var_129:name_78;
      
      private var var_116:name_78;
      
      private var var_131:name_117;
      ...
      private var var_112:Logo;
      
      private var var_118:Bitmap;
      
      private var var_111:String = "BR";
      
      private var var_126:Number = 0;
      
      private var var_125:Number = 0;
      
      private var var_134:Boolean;
      
      public function name_81(width:int, height:int, renderToBitmap:Boolean = false, backgroundColor:uint = 0, backgroundAlpha:Number = 1, antiAlias:int = 0)
      {
         var item:ContextMenuItem;
         var menu:ContextMenu;
         this.var_117 = new Vector.<MouseEvent>();
         this.indices = new Vector.<int>();
         this.surfaces = new Vector.<name_117>();
         this.geometries = new Vector.<name_119>();
         this.var_128 = new Vector.<name_114>();
         this.alternativa3d::var_127 = new Vector.<Vector3D>();
         this.alternativa3d::var_133 = new Vector.<Vector3D>();
         this.var_124 = new Vector.<Point>();
         this.var_121 = new Vector.<Vector.<name_117>>();
         this.var_120 = new Vector.<Vector.<Number>>();
         this.var_130 = new Vector.<int>();
         this.var_132 = new Vector.<int>();
         super();
         if(width < 50)
         {
            width = 50;
         ...
         this.alternativa3d::var_110 = width;
         this.alternativa3d::_height = height;
         this.var_134 = renderToBitmap;
         ...
         this.area.width = this.alternativa3d::var_110;
         ...
         {
            drawDistanceVertexProcedure = name_114.name_140(["#v0=distance","#c0=transform0","#c1=transform1","#c2=transform2","#c3=coefficient","#c4=projection","dp4 t0.x, i0, c0","dp4 t0.y, i0, c1","dp4 t0.z, i0, c2","mul v0.x, t0.z, c3.z","mov v0.y, i0.x","mov v0.z, i0.x","mov v0.w, i0.x","mul t1.x, t0.x, c4.x","mul t1.y, t0.y, c4.y","mul t0.w, t0.z, c4.z","add t1.z, t0.w, c4.w","mov t3.z, c4.x","div t3.z, t3.z, c4.x","sub t3.z, t3.z, c3.w","mul t1.w, t0.z, t3.z","add t1.w, t1.w, c3.w","mul t0.x, c3.x, t1.w","mul t0.y, c3.y, t1.w","add t1.x, t1.x, t0.x","add t1.y, t1.y, t0.y","mov o0, t1"],"mouseEventsVertex");
            drawDistanceFragment = new name_121(Context3DProgramType.FRAGMENT);
            drawDistanceFragment.name_123(new name_114(["mov t0.z, c0.z","mov t0.w, c0.w","frc t0.y, v0.x","sub t0.x, v0.x, t0.y","mul t0.x, t0.x, c0.x","mov o0, ft0","#v0=distance","#c0=code"],"mouseEventsFragment"));
         }
         addEventListener(MouseEvent.MOUSE_DOWN,this.method_229);
         addEventListener(MouseEvent.CLICK,this.method_229);
         addEventListener(MouseEvent.DOUBLE_CLICK,this.method_229);
         addEventListener(MouseEvent.MOUSE_MOVE,this.method_229);
         addEventListener(MouseEvent.MOUSE_OVER,this.method_229);
         addEventListener(MouseEvent.MOUSE_WHEEL,this.method_229);
         addEventListener(MouseEvent.MOUSE_OUT,this.method_238);
         addEventListener(Event.ADDED_TO_STAGE,this.method_80);
         addEventListener(Event.REMOVED_FROM_STAGE,this.method_81);
      }
      
      private function method_229(mouseEvent:MouseEvent) : void
      {
         var prev:int = this.var_113 - 1;
         if(this.var_113 > 0 && mouseEvent.type == "mouseMove" && (this.var_117[prev] as MouseEvent).type == "mouseMove")
         {
            this.var_117[prev] = mouseEvent;
         }
         else
         {
            this.var_117[this.var_113] = mouseEvent;
            ++this.var_113;
         }
         this.var_119 = mouseEvent;
      }
      
      private function method_238(mouseEvent:MouseEvent) : void
      {
         this.var_117[this.var_113] = mouseEvent;
         ++this.var_113;
         this.var_119 = null;
      ...
      {
         this.alternativa3d::var_114 = new BitmapData(this.alternativa3d::var_110,this.alternativa3d::_height,this.backgroundAlpha < 1,this.backgroundColor);
         this.container.bitmapData = this.alternativa3d::var_114;
         this.container.smoothing = true;
      }
      
      private function method_80(e:Event) : void
      {
         stage.addEventListener(KeyboardEvent.KEY_DOWN,this.method_15);
         stage.addEventListener(KeyboardEvent.KEY_UP,this.method_233);
      }
      
      private function method_81(e:Event) : void
      {
         stage.removeEventListener(KeyboardEvent.KEY_DOWN,this.method_15);
         stage.removeEventListener(KeyboardEvent.KEY_UP,this.method_233);
         this.altKey = false;
         this.ctrlKey = false;
         this.shiftKey = false;
      }
      
      private function method_15(keyboardEvent:KeyboardEvent) : void
      {
         this.altKey = keyboardEvent.altKey;
         this.ctrlKey = keyboardEvent.ctrlKey;
         this.shiftKey = keyboardEvent.shiftKey;
         if(this.ctrlKey && this.shiftKey && keyboardEvent.keyCode == Keyboard.F1 && this.var_118 == null)
         {
            this.var_118 = new Bitmap(Logo.image);
            this.var_118.x = Math.round((this.alternativa3d::var_110 - this.var_118.width) / 2);
            this.var_118.y = Math.round((this.alternativa3d::_height - this.var_118.height) / 2);
            super.addChild(this.var_118);
            setTimeout(this.method_241,2048);
         }
      }
      
      private function method_233(keyboardEvent:KeyboardEvent) : void
      {
         this.altKey = keyboardEvent.altKey;
         this.ctrlKey = keyboardEvent.ctrlKey;
         this.shiftKey = keyboardEvent.shiftKey;
      ...
      private function method_241() : void
      {
         if(this.var_118 != null)
         {
            super.removeChild(this.var_118);
            this.var_118 = null;
         }
      }
      
      alternativa3d function calculateRays(camera:name_124) : void
      {
         var i:int = 0;
         ...
         {
            mouseMoved = false;
            for(i = 0; i < this.var_113; )
            {
               mouseEvent = this.var_117[i];
            ...
            if(!mouseMoved)
            {
               renderEvent.localX = this.var_119.localX;
               renderEvent.localY = this.var_119.localY;
               renderEvent.ctrlKey = this.ctrlKey;
               renderEvent.altKey = this.altKey;
               renderEvent.shiftKey = this.shiftKey;
               renderEvent.buttonDown = this.var_119.buttonDown;
               renderEvent.delta = 0;
               this.var_117[this.var_113] = renderEvent;
               ++this.var_113;
            }
         }
         var mouseX:Number = 1e+22;
         var mouseY:Number = 1e+22;
         for(i = 0; i < this.var_113; i++)
         {
            mouseEvent = this.var_117[i];
            if(mouseEvent.type != "mouseOut")
            {
               if(mouseEvent.localX != mouseX || mouseEvent.localY != mouseY)
               {
                  ...
                  if(this.alternativa3d::raysLength < this.alternativa3d::var_127.length)
                  {
                     origin = this.alternativa3d::var_127[this.alternativa3d::raysLength];
                     direction = this.alternativa3d::var_133[this.alternativa3d::raysLength];
                     coefficient = this.var_124[this.alternativa3d::raysLength];
                  }
                  else
                  {
                     origin = new Vector3D();
                     ...
                     this.alternativa3d::var_127[this.alternativa3d::raysLength] = origin;
                     this.alternativa3d::var_133[this.alternativa3d::raysLength] = direction;
                     this.var_124[this.alternativa3d::raysLength] = coefficient;
                     this.var_121[this.alternativa3d::raysLength] = new Vector.<name_117>();
                     this.var_120[this.alternativa3d::raysLength] = new Vector.<Number>();
                  }
                  if(!camera.orthographic)
                  {
                     direction.x = mouseX - this.alternativa3d::var_110 * 0.5;
                     ...
                     direction.normalize();
                     coefficient.x = mouseX * 2 / this.alternativa3d::var_110;
                  ...
                  else
                  {
                     ...
                     direction.y = 0;
                     direction.z = 1;
                     origin.x = mouseX - this.alternativa3d::var_110 * 0.5;
      ...
      alternativa3d function name_398(surface:name_117, geometry:name_119, procedure:name_114) : void
      {
         this.surfaces[this.var_115] = surface;
         this.geometries[this.var_115] = geometry;
         this.var_128[this.var_115] = procedure;
         ++this.var_115;
      }
      
      alternativa3d function method_244(stage3D:Stage3D, context:Context3D) : void
      {
         ...
         if(isIncubator)
         {
            if(this.alternativa3d::var_110 > 2048)
            {
               this.alternativa3d::var_110 = 2048;
            }
         ...
         if(this.alternativa3d::var_114 == null)
         {
            ...
            if(isIncubator)
            {
               if(vis)
               {
                  ...
                  point.x = this.alternativa3d::var_110;
         ...
         else
         {
            ...
            if(this.alternativa3d::var_110 != this.alternativa3d::var_114.width || this.alternativa3d::_height != this.alternativa3d::var_114.height || this.backgroundAlpha < 1 != this.alternativa3d::var_114.transparent)
            {
               this.alternativa3d::var_114.dispose();
               this.method_232();
            }
         }
         context.configureBackBuffer(this.alternativa3d::var_110,this.alternativa3d::_height,this.antiAlias);
      ...
      alternativa3d function method_243(context:Context3D, camera:name_124) : void
      {
         var i:int = 0;
         var raySurfaces:Vector.<name_117> = null;
         ...
         if(this.var_113 > 0)
         {
            if(this.var_115 > 0)
            {
               this.method_236(context,camera,this.alternativa3d::var_110,this.alternativa3d::_height);
               for(i = 0; i < this.alternativa3d::raysLength; )
               {
                  raySurfaces = this.var_121[i];
                  rayDepths = this.var_120[i];
            ...
            for(i = 0; i < this.var_113; i++)
            {
               ...
               {
                  case "mouseDown":
                     this.method_228(index);
                     if(this.target != null)
                     {
                        this.method_226(MouseEvent3D.MOUSE_DOWN,mouseEvent,camera,this.target,this.targetSurface,this.method_227(this.target,branch));
                     }
                     this.var_123 = this.target;
                     break;
                  case "mouseWheel":
                     this.method_228(index);
                     if(this.target != null)
                     {
                        this.method_226(MouseEvent3D.MOUSE_WHEEL,mouseEvent,camera,this.target,this.targetSurface,this.method_227(this.target,branch));
                     }
                     break;
                  case "click":
                     this.method_228(index);
                     if(this.target != null)
                     {
                        this.method_226(MouseEvent3D.MOUSE_UP,mouseEvent,camera,this.target,this.targetSurface,this.method_227(this.target,branch));
                        if(this.var_123 == this.target)
                        {
                           this.var_129 = this.target;
                           this.method_226(MouseEvent3D.CLICK,mouseEvent,camera,this.target,this.targetSurface,this.method_227(this.target,branch));
                        }
                     }
                     this.var_123 = null;
                     break;
                  case "doubleClick":
                     ...
                     if(this.target != null)
                     {
                        ...
                        if(this.var_123 == this.target)
                        {
                           this.method_226(this.var_129 == this.target && this.target.doubleClickEnabled ? MouseEvent3D.DOUBLE_CLICK : MouseEvent3D.CLICK,mouseEvent,camera,this.target,this.targetSurface,this.method_227(this.target,branch));
                        }
                     }
                     this.var_129 = null;
                     this.var_123 = null;
                  ...
                  case "mouseMove":
                     ...
                     if(this.target != null)
                     {
                        this.method_226(MouseEvent3D.MOUSE_MOVE,mouseEvent,camera,this.target,this.targetSurface,this.method_227(this.target,branch));
                     }
                     if(this.var_116 != this.target)
                     {
                        this.method_231(mouseEvent,camera);
                     }
                     break;
                  case "mouseOut":
                     this.var_119 = null;
         ...
         this.var_115 = 0;
         this.var_117.length = 0;
         this.var_113 = 0;
         for(i = 0; i < this.alternativa3d::raysLength; i++)
         {
            this.var_121[i].length = 0;
            this.var_120[i].length = 0;
         }
         this.alternativa3d::raysLength = 0;
      }
      
      private function method_236(context:Context3D, camera:name_124, contextWidth:int, contextHeight:int) : void
      {
         var vLinker:name_121 = null;
         ...
         var drawRectGeometry:name_119 = drawRectGeometries[context];
         if(drawRectGeometry == null)
         {
            drawRectGeometry = new name_119(4);
            drawRectGeometry.addVertexStream([name_126.POSITION,name_126.POSITION,name_126.POSITION,name_126.TEXCOORDS[0],name_126.TEXCOORDS[0]]);
            drawRectGeometry.setAttributeValues(name_126.POSITION,Vector.<Number>([0,0,1,0,1,1,1,1,1,1,0,1]));
            drawRectGeometry.setAttributeValues(name_126.TEXCOORDS[0],Vector.<Number>([0,0,0,1,1,1,1,0]));
         ...
         var drawColoredRectProgram:name_127 = drawColoredRectPrograms[context];
         if(drawColoredRectProgram == null)
         {
            vLinker = new name_121(Context3DProgramType.VERTEX);
            vLinker.name_123(name_114.name_140(["#a0=a0","#c0=c0","mul t0.x, a0.x, c0.x","mul t0.y, a0.y, c0.y","add o0.x, t0.x, c0.z","add o0.y, t0.y, c0.w","mov o0.z, a0.z","mov o0.w, a0.z"]));
            fLinker = new name_121(Context3DProgramType.FRAGMENT);
            fLinker.name_123(name_114.name_140(["#c0=c0","mov o0, c0"]));
            drawColoredRectProgram = new name_127(vLinker,fLinker);
            drawColoredRectProgram.upload(context);
            drawColoredRectPrograms[context] = drawColoredRectProgram;
         }
         var drawTexturedRectProgram:name_127 = drawTexturedRectPrograms[context];
         if(drawTexturedRectProgram == null)
         {
            vLinker = new name_121(Context3DProgramType.VERTEX);
            vLinker.name_123(name_114.name_140(["#a0=a0","#a1=a1","#v0=v0","#c0=c0","#c1=c1","mul v0, a1, c1","mul t0.x, a0.x, c0.x","mul t0.y, a0.y, c0.y","add o0.x, t0.x, c0.z","add o0.y, t0.y, c0.w","mov o0.z, a0.z","mov o0.w, a0.z"]));
            fLinker = new name_121(Context3DProgramType.FRAGMENT);
            fLinker.name_123(name_114.name_140(["#v0=v0","#s0=s0","tex t0, v0, s0 <2d, nearest, mipnone>","mov o0, t0"]));
            drawTexturedRectProgram = new name_127(vLinker,fLinker);
         ...
         var m0:Number = camera.alternativa3d::m0;
         var m5:Number = camera.alternativa3d::m5;
         var m10:Number = camera.alternativa3d::m10;
         var m11:Number = camera.alternativa3d::m14;
         ...
         for(i = 0; i < this.alternativa3d::raysLength; )
         {
            rayCoefficients = this.var_124[i];
            i++;
            for(j = 0; j < this.var_115; )
            {
               if(pixelIndex == 0)
               {
                  if(this.antiAlias > 0)
                  ...
                  {
                     drawColoredRectConst[0] = this.alternativa3d::raysLength * this.var_115 * 2 / contextWidth;
                     drawColoredRectConst[1] = -2 / contextHeight;
                     context.setDepthTest(false,Context3DCompareMode.ALWAYS);
                     context.setProgram(drawColoredRectProgram.program);
                     context.setVertexBufferAt(0,drawRectGeometry.alternativa3d::getVertexBuffer(name_126.POSITION),drawRectGeometry.alternativa3d::_attributesOffsets[name_126.POSITION],name_126.alternativa3d::FORMATS[name_126.POSITION]);
                     ...
                     context.drawTriangles(drawRectGeometry.alternativa3d::name_132,0,2);
                     context.setVertexBufferAt(0,null);
                  }
               }
               scissor.x = pixelIndex;
               context.setScissorRectangle(scissor);
               this.method_237(context,camera,j,m0,m5,m10,m11,(pixelIndex * 2 / contextWidth - rayCoefficients.x) * drawTextureWidthScale + drawTextureWidthOffset,rayCoefficients.y * drawTextureHeightScale - drawTextureHeightOffset,kZ,fragmentConst,camera.orthographic);
               this.var_130[pixelIndex] = i - 1;
               this.var_132[pixelIndex] = j;
               j++;
               pixelIndex++;
               if(pixelIndex >= contextWidth || i >= this.alternativa3d::raysLength && j >= this.var_115)
               {
                  if(this.antiAlias > 0)
                  {
                     ...
                     context.setVertexBufferAt(0,drawRectGeometry.alternativa3d::getVertexBuffer(name_126.POSITION),drawRectGeometry.alternativa3d::_attributesOffsets[name_126.POSITION],name_126.alternativa3d::FORMATS[name_126.POSITION]);
                     context.setVertexBufferAt(1,drawRectGeometry.alternativa3d::getVertexBuffer(name_126.TEXCOORDS[0]),drawRectGeometry.alternativa3d::_attributesOffsets[name_126.TEXCOORDS[0]],name_126.alternativa3d::FORMATS[name_126.TEXCOORDS[0]]);
                     context.setProgramConstantsFromVector(Context3DProgramType.VERTEX,0,drawColoredRectConst);
                  ...
                  for(k = 0; k < pixelIndex; )
                  {
                     ...
                     {
                        ind = this.var_130[k];
                        raySurfaces = this.var_121[ind];
                        rayDepths = this.var_120[ind];
                        ind = this.var_132[k];
      ...
      private function method_237(context:Context3D, camera:name_124, index:int, m0:Number, m5:Number, m10:Number, m14:Number, xOffset:Number, yOffset:Number, vertexConst:Number, fragmentConst:Number, orthographic:Boolean) : void
      {
         var i:int = 0;
         var vertex:name_121 = null;
         var position:String = null;
         var surface:name_117 = this.surfaces[index];
         var geometry:name_119 = this.geometries[index];
         var procedure:name_114 = this.var_128[index];
         var object:name_78 = surface.alternativa3d::object;
         var drawDistanceProgram:name_127 = drawDistancePrograms[procedure];
         if(drawDistanceProgram == null)
         {
            vertex = new name_121(Context3DProgramType.VERTEX);
            position = "position";
            vertex.name_120(position,name_115.ATTRIBUTE);
            if(procedure != null)
            {
               vertex.name_123(procedure);
               vertex.name_120("localPosition",name_115.TEMPORARY);
               vertex.name_118(procedure,position);
               vertex.name_125(procedure,"localPosition");
               position = "localPosition";
            }
            vertex.name_123(drawDistanceVertexProcedure);
            vertex.name_118(drawDistanceVertexProcedure,position);
            drawDistanceProgram = new name_127(vertex,drawDistanceFragment);
            drawDistanceFragment.name_133(vertex);
            drawDistanceProgram.upload(context);
            drawDistancePrograms[procedure] = drawDistanceProgram;
         }
         var buffer:VertexBuffer3D = geometry.alternativa3d::getVertexBuffer(name_126.POSITION);
         if(buffer == null)
         {
            return;
         }
         drawUnit.alternativa3d::name_403 = 0;
         drawUnit.alternativa3d::name_404 = 0;
         drawUnit.alternativa3d::name_407 = 0;
         object.alternativa3d::setTransformConstants(drawUnit,surface,drawDistanceProgram.vertexShader,camera);
         drawUnit.alternativa3d::name_412(drawDistanceProgram.vertexShader.getVariableIndex("transform0"),object.alternativa3d::localToCameraTransform);
         drawUnit.alternativa3d::name_144(drawDistanceProgram.vertexShader.getVariableIndex("coefficient"),xOffset,yOffset,vertexConst,orthographic ? 1 : 0);
         drawUnit.alternativa3d::name_144(drawDistanceProgram.vertexShader.getVariableIndex("projection"),m0,m5,m10,m14);
         drawUnit.alternativa3d::name_134(drawDistanceProgram.fragmentShader.getVariableIndex("code"),fragmentConst,0,0,1);
         context.setProgram(drawDistanceProgram.program);
         context.setVertexBufferAt(0,buffer,geometry.alternativa3d::_attributesOffsets[name_126.POSITION],name_126.alternativa3d::FORMATS[name_126.POSITION]);
         for(i = 0; i < drawUnit.alternativa3d::name_403; i++)
         {
            context.setVertexBufferAt(drawUnit.alternativa3d::name_405[i],drawUnit.alternativa3d::vertexBuffers[i],drawUnit.alternativa3d::name_411[i],drawUnit.alternativa3d::name_409[i]);
         }
         ...
         context.drawTriangles(geometry.alternativa3d::name_132,surface.indexBegin,surface.numTriangles);
         context.setVertexBufferAt(0,null);
         for(i = 0; i < drawUnit.alternativa3d::name_403; i++)
         {
            context.setVertexBufferAt(drawUnit.alternativa3d::name_405[i],null);
         }
      }
      
      private function sort(surfaces:Vector.<name_117>, depths:Vector.<Number>, length:int) : void
      {
         var r:int = 0;
         var j:int = 0;
         var l:int = 0;
      ...
      private function method_231(mouseEvent:MouseEvent, camera:name_124) : void
      {
         var changedBranchLength:int = 0;
         var i:int = 0;
         var j:int = 0;
         var object:name_78 = null;
         this.method_227(this.target,branch);
         this.method_227(this.var_116,overedBranch);
         var branchLength:int = int(branch.length);
         var overedBranchLength:int = int(overedBranch.length);
         if(this.var_116 != null)
         {
            this.method_226(MouseEvent3D.MOUSE_OUT,mouseEvent,camera,this.var_116,this.var_131,overedBranch,true,this.target);
            ...
            if(changedBranchLength > 0)
            {
               ...
               this.method_226(MouseEvent3D.ROLL_OUT,mouseEvent,camera,this.var_116,this.var_131,changedBranch,false,this.target);
            }
         }
         if(this.target != null)
         {
            ...
            {
               changedBranch.length = changedBranchLength;
               this.method_226(MouseEvent3D.ROLL_OVER,mouseEvent,camera,this.target,this.targetSurface,changedBranch,false,this.var_116);
            }
            this.method_226(MouseEvent3D.MOUSE_OVER,mouseEvent,camera,this.target,this.targetSurface,branch,true,this.var_116);
         ...
         this.var_116 = this.target;
         this.var_131 = this.targetSurface;
      }
      
      private function method_227(object:name_78, vector:Vector.<name_78>) : Vector.<name_78>
      {
      ...
      private function method_226(type:String, mouseEvent:MouseEvent, camera:name_124, target:name_78, targetSurface:name_117, objects:Vector.<name_78>, bubbles:Boolean = true, relatedObject:name_78 = null) : void
      {
         var object:name_78 = null;
         ...
         for(i = oblectsLength - 1; i > 0; )
         {
            ...
            if(object.alternativa3d::captureListeners != null)
            {
               ...
               if(vector != null)
               {
                  ...
                  {
                     this.method_234(camera,target.alternativa3d::cameraToLocalTransform,this.var_122,mouseEvent);
                     ...
                     mouseEvent3D.alternativa3d::name_394 = target;
                     mouseEvent3D.alternativa3d::var_109 = targetSurface;
                  }
                  mouseEvent3D.alternativa3d::name_390 = object;
                  mouseEvent3D.alternativa3d::name_388 = 1;
                  ...
                  for(j = 0; j < length; )
                  {
                     ...
                     if(mouseEvent3D.alternativa3d::var_108)
                     {
                        return;
                     }
                     j++;
         ...
         for(i = 0; i < oblectsLength; )
         {
            ...
            if(object.alternativa3d::bubbleListeners != null)
            {
               ...
               if(vector != null)
               {
                  ...
                  mouseEvent3D.alternativa3d::name_390 = object;
                  mouseEvent3D.alternativa3d::name_388 = i == 0 ? 2 : 3;
                  length = int(vector.length);
                  for(j = 0; j < length; functions[j] = vector[j],j++)
                  {
                  }
      ...
      private function method_234(camera:name_124, transform:name_139, z:Number, mouseEvent:MouseEvent) : void
      {
         var x:Number = NaN;
         var y:Number = NaN;
         if(!camera.orthographic)
         {
            x = z * (mouseEvent.localX - this.alternativa3d::var_110 * 0.5) / camera.alternativa3d::focalLength;
            y = z * (mouseEvent.localY - this.alternativa3d::_height * 0.5) / camera.alternativa3d::focalLength;
         }
         else
         {
            x = mouseEvent.localX - this.alternativa3d::var_110 * 0.5;
      ...
      private function method_228(index:int) : void
      {
         var source:name_78 = null;
         var surface:name_117 = null;
         var depth:Number = NaN;
         var object:name_78 = null;
         var potentialTarget:name_78 = null;
         var obj:name_78 = null;
         var surfaces:Vector.<name_117> = this.var_121[index];
         var depths:Vector.<Number> = this.var_120[index];
      ...
      {
         return this.alternativa3d::var_114 != null;
      }
      ...
      public function set renderToBitmap(value:Boolean) : void
      {
         ...
         else if(this.alternativa3d::var_114 != null)
         {
            this.container.bitmapData = null;
            this.alternativa3d::var_114.dispose();
            this.alternativa3d::var_114 = null;
         }
      }
      
      public function get canvas() : BitmapData
      {
         return this.alternativa3d::var_114;
      }
      ...
      public function method_242() : void
      {
         ...
         {
            this.var_112 = new Logo();
            super.addChild(this.var_112);
            this.method_230();
         }
      }
      
      public function name_106() : void
      {
         if(this.var_112 != null)
         {
            super.removeChild(this.var_112);
            this.var_112 = null;
         }
      }
      
      public function get method_240() : String
      {
         return this.var_111;
      }
      
      public function set method_240(value:String) : void
      {
         this.var_111 = value;
         this.method_230();
      }
      
      public function get method_239() : Number
      {
         return this.var_126;
      }
      
      public function set method_239(value:Number) : void
      {
         this.var_126 = value;
         this.method_230();
      }
      
      public function get method_235() : Number
      {
         return this.var_125;
      }
      
      public function set method_235(value:Number) : void
      {
         this.var_125 = value;
         this.method_230();
      }
      ...
      private function method_230() : void
      {
         if(this.var_112 != null)
         {
            if(this.var_111 == StageAlign.TOP_LEFT || this.var_111 == StageAlign.LEFT || this.var_111 == StageAlign.BOTTOM_LEFT)
            {
               this.var_112.x = Math.round(this.var_126);
            }
            if(this.var_111 == StageAlign.TOP || this.var_111 == StageAlign.BOTTOM)
            {
               this.var_112.x = Math.round((this.alternativa3d::var_110 - this.var_112.width) / 2);
            }
            if(this.var_111 == StageAlign.TOP_RIGHT || this.var_111 == StageAlign.RIGHT || this.var_111 == StageAlign.BOTTOM_RIGHT)
            {
               this.var_112.x = Math.round(this.alternativa3d::var_110 - this.var_126 - this.var_112.width);
            }
            if(this.var_111 == StageAlign.TOP_LEFT || this.var_111 == StageAlign.TOP || this.var_111 == StageAlign.TOP_RIGHT)
            {
               this.var_112.y = Math.round(this.var_125);
            }
            if(this.var_111 == StageAlign.LEFT || this.var_111 == StageAlign.RIGHT)
            {
               this.var_112.y = Math.round((this.alternativa3d::_height - this.var_112.height) / 2);
            }
            if(this.var_111 == StageAlign.BOTTOM_LEFT || this.var_111 == StageAlign.BOTTOM || this.var_111 == StageAlign.BOTTOM_RIGHT)
            {
               this.var_112.y = Math.round(this.alternativa3d::_height - this.var_125 - this.var_112.height);
            }
         }
      }
      ...
      {
         return this.alternativa3d::var_110;
      }
      ...
      override public function set width(value:Number) : void
      {
         ...
         this.alternativa3d::var_110 = value;
