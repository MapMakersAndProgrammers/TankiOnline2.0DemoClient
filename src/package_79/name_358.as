package package_79
{
   ...
   public class name_358 implements name_357
   {
      ...
      private static var normal:name_145 = new name_145();
      
      private static var collisionBox:name_311 = new name_311(new name_145(),4294967295,0);
      
      private var cellSize:Number;
      
      private var var_609:name_334 = new name_334();
      
      private var denseArray:Vector.<name_276>;
      ...
      private var var_611:Vector.<name_509>;
      ...
      public function name_358()
      {
         super();
         this.var_611 = new Vector.<name_509>();
      ...
      public function name_434(bodyCollisionData:name_406) : void
      {
         if(this.method_258(bodyCollisionData.body) >= 0)
         {
            throw new Error("Body collision data already exists");
         }
         var bodyCollisionGridData:name_509 = name_509.create();
      ...
      public function name_433(bodyCollisionData:name_406) : void
      {
         var index:int = this.method_258(bodyCollisionData.body);
         if(index < 0)
         {
            throw new Error("Body collision data not found");
         }
         --this.var_612;
         var lastBodyEntry:name_509 = this.var_611[this.var_612];
         lastBodyEntry.index = index;
         name_509(this.var_611[index]).destroy();
      ...
      public function method_271() : Number
      {
         return this.cellSize;
      }
      
      public function method_275() : name_334
      {
         return this.var_609.clone();
      }
      
      public function method_272() : int
      {
         return this.numCellsX;
      }
      
      public function method_274() : int
      {
         return this.numCellsY;
      }
      
      public function method_273() : int
      {
         return this.numCellsZ;
      }
      
      public function method_276() : int
      {
         return this.var_616;
      }
      
      public function method_270(x:int, y:int, z:int) : int
      {
         var cellIndex:int = x * this.numCellsY * this.numCellsZ + y * this.numCellsZ + z;
         return this.denseCellIndices[cellIndex] >>> 24;
      }
      
      public function name_362(cellSize:Number, staticPrimitives:Vector.<name_276>) : void
      {
         this.method_268(staticPrimitives,cellSize);
         this.method_259(staticPrimitives);
         this.method_264();
      }
               ...
               for(k = kmin; k <= kmax; k++)
               {
                  ...
                  for(bodyCellEntry = this.bodyCellEntries[index]; bodyCellEntry != null; )
                  {
                     ...
                     if(data.timestamp != ts)
                     {
                        ...
                        if(d < radiusSqr)
                        {
                           if(filter == null || Boolean(filter.name_500(center,body)))
                           {
                              if(result == null)
                              {
                                 result = new Vector.<name_485>();
                              }
                              result.push(new name_485(body,Math.sqrt(d)));
                           }
                        }
                     }
      ...
      {
         var bodyCollisionData:name_509 = null;
         this.method_255();
         for(var i:int = 0; i < this.var_612; i++)
         {
            bodyCollisionData = this.var_611[i];
            contacts = this.method_262(bodyCollisionData,contacts);
         }
         return this.method_267(contacts);
      }
      ...
      private function method_268(staticPrimitives:Vector.<name_276>, cellSize:Number) : void
      {
         var collisionPrimitive:name_276 = null;
         this.cellSize = cellSize;
         this.var_609.name_426();
         for each(collisionPrimitive in staticPrimitives)
         {
            this.var_609.name_424(collisionPrimitive.calculateAABB());
         }
         this.var_609.name_510(cellSize + EPSILON);
         this.numCellsX = int(this.var_609.name_513() / cellSize) + 1;
         this.numCellsY = int(this.var_609.name_512() / cellSize) + 1;
         this.numCellsZ = int(this.var_609.name_514() / cellSize) + 1;
      ...
      private function method_259(staticPrimitives:Vector.<name_276>) : void
      {
         var index:int = 0;
         ...
         var cellCounters:Vector.<int> = this.method_260(staticPrimitives);
         this.var_616 = 0;
         ...
         this.denseArray = new Vector.<name_276>(denseArraySize);
      ...
      private function method_260(staticPrimitives:Vector.<name_276>) : Vector.<int>
      {
         var bb:name_334 = null;
         var imin:int = 0;
         var imax:int = 0;
      ...
      private function method_267(contacts:name_482) : name_482
      {
         var currentBodyCellEntry:BodyCellEntry = null;
         var currentBodyData:name_509 = null;
         var bodyCollisionGridData:name_509 = null;
         var imin:int = 0;
         var imax:int = 0;
         var jmin:int = 0;
         var jmax:int = 0;
         ...
         for(var occupiedCell:OccupiedCellIndex = this.var_614; occupiedCell != null; )
         {
            for(currentBodyCellEntry = this.bodyCellEntries[occupiedCell.index]; currentBodyCellEntry != null; )
            {
               ...
               contacts = this.method_257(currentBodyData.body,currentBodyData.index,currentBodyData.simplePrimitives,currentBodyCellEntry.next,numBodies,contacts);
               ...
               for(i = imin; i <= imax; i++)
               {
                  for(j = jmin; j <= jmax; j++)
                  {
                     for(k = kmin; k <= kmax; )
                     {
                        ...
                        {
                           contacts = this.method_257(currentBodyData.body,currentBodyData.index,currentBodyData.simplePrimitives,this.bodyCellEntries[cellIndex],numBodies,contacts);
                        }
                        k++;
                     }
                  }
      ...
      private function method_257(body:name_186, bodyIndex:int, bodyPrimitives:Vector.<name_276>, cellStartEntry:BodyCellEntry, numBodies:int, contacts:name_482) : name_482
      {
         var index2:int = 0;
         var min:int = 0;
         var max:int = 0;
         var bitIndex:int = 0;
         var mask:int = 0;
         var body2:name_186 = null;
         var bodyPrimitives2:Vector.<name_276> = null;
         var numPrimitives2:int = 0;
         var i:int = 0;
         var collisionPrimitive1:name_276 = null;
         var j:int = 0;
         var collisionPrimitive2:name_276 = null;
                  ...
                  if(body2.aabb.intersects(body.aabb,EPSILON))
                  {
                     ...
                     for(i = 0; i < numPrimitives1; i++)
                     {
                        ...
                        for(j = 0; j < numPrimitives2; j++)
                        {
                           ...
                           {
                              contacts = this.method_266(body,bodyPrimitives,numPrimitives1,body2,bodyPrimitives2,numPrimitives2,contacts);
                           }
                        }
                     }
                  }
      ...
      private function method_266(body1:name_186, primitives1:Vector.<name_276>, numPrimitives1:int, body2:name_186, primitives2:Vector.<name_276>, numPrimitives2:int, contact:name_482) : name_482
      {
      ...
      private function method_262(bodyCollisionData:name_509, contacts:name_482) : name_482
      {
         var jj:int = 0;
         var kk:int = 0;
         var cellIndex:int = 0;
         ...
         var index:int = 0;
         var staticCollisionPrimitive:name_276 = null;
         var bpi:int = 0;
         var bodyCollisionPrimitive:name_276 = null;
         ...
         var bodyPrimitives:Vector.<name_276> = bodyCollisionData.detailedPrimitives;
      ...
      public function raycast(origin:name_145, direction:name_145, collisionMask:int, maxTime:Number, filter:name_488, result:name_189) : Boolean
      {
         if(this.var_617)
         {
            this.method_255();
         ...
         this.method_256(origin,direction,maxTime,this.var_610);
         this.var_610.clear();
         if(this.var_610.hasHit)
         {
            if(result.t < maxTime)
            {
               result.position.copy(origin).name_458(result.t,direction);
               return true;
            }
         }
         return false;
      ...
      public function name_246(origin:name_145, direction:name_145, collisionMask:int, maxTime:Number, filter:name_488, result:name_189) : Boolean
      {
         this.var_610.collisionMask = collisionMask;
         this.var_610.filter = filter;
         this.var_610.result = result;
      ...
      public function method_256(origin:name_145, direction:name_145, maxTime:Number, visitor:class_25) : void
      {
         var t:Number = NaN;
         var i:int = 0;
         var j:int = 0;
         ...
         var p:name_145 = new name_145();
         var pointInBounds:Boolean = this.var_609.name_511(origin,EPSILON);
         if(!pointInBounds)
         {
            ...
            p.copy(origin).name_458(t,direction);
      ...
      private function method_255() : void
      {
         var bodyCollisionData:name_509 = null;
      ...
      private function method_258(body:name_186) : int
      {
         var bodyCollisionGridData:name_509 = null;
      ...
      private function method_261() : void
      {
...
class RaycastCellVisitor implements class_25
{
   public static var EPSILON:Number = 0.0001;
   
   private static var normal:name_145 = new name_145();
   
   public var denseArray:Vector.<name_276>;
   ...
   public var filter:name_488;
   
   public var result:name_189;
   
   public var hasHit:Boolean;
   
   private var nearestPrimitive:name_276;
   
   private var nearestNormal:name_145 = new name_145();
   ...
   public function visitCell(celli:int, cellj:int, cellk:int, axis:int, cellEntryTime:Number, cellMaxTime:Number, timestamp:int, rayOrigin:name_145, rayDirection:name_145) : Boolean
   {
      var collisionPrimitive:name_276 = null;
      var time:Number = NaN;
      var bodyCellEntry:BodyCellEntry = null;
      var data:name_509 = null;
      var detailedPrimitives:Vector.<name_276> = null;
      ...
      for(var i:int = startIndex; i < endIndex; )
      {
         ...
         if(collisionPrimitive.timestamp != timestamp)
         {
            ...
            if((collisionPrimitive.collisionGroup & this.collisionMask) != 0)
            {
               ...
               if(time > 0 && time < minTime && (this.filter == null || Boolean(this.filter.name_493(collisionPrimitive))))
               {
                  minTime = time;
                  if(time < cellMaxTime)
                  {
