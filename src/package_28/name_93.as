package package_28
{
   ...
   public class name_93 extends name_129
   {
      ...
      public function name_93(data:BitmapData)
      {
         super();
         this.data = data;
      }
      
      alternativa3d static function method_272(texture:Texture, bitmapData:BitmapData) : void
      {
      ...
      alternativa3d function method_272(texture:Texture, bitmapData:BitmapData) : void
      {
         rect.width = bitmapData.width;
         rect.height = bitmapData.height;
         var level:int = 1;
