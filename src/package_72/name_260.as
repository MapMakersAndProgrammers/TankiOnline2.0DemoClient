package package_72
{
   ...
   public class name_260 extends PooledObject implements IGraphicEffect
   {
      ...
      private var velocity:name_194 = new name_194();
      ...
      public function init(width:Number, height:Number, frames:Vector.<class_4>, position:name_194, velocity:name_194, acceleration:Number, rotation:Number, fps:Number, loop:Boolean, originX:Number = 0.5, originY:Number = 0.5) : void
      {
      ...
      {
         system.method_60().addChild(this.sprite);
      }
      ...
      public function play(camera:GameCamera) : Boolean
      {
         ...
         this.position.method_362(dt,this.velocity);
