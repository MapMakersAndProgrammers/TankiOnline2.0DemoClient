package package_61
{
   ...
   public class VectorCodecA3D2TrackLevel2 implements name_152
   {
      ...
      {
         this.elementCodec = protocol.name_448(new name_148(A3D2Track,false));
      ...
      public function method_296(protocolBuffer:name_442) : Object
      {
         ...
         for(var i1:int = 0; i1 < length1; )
         {
            if(!protocolBuffer.optionalMap.name_447())
            {
               ...
               {
                  items2[i2] = A3D2Track(this.elementCodec.method_296(protocolBuffer));
               }
            }
            i1++;
         }
